...
The key is understanding compatibility requirements before purchasing—not after. A stroller without car seat compatibility costs you nothing extra; it's simply not an option for travel system use. Plan ahead, verify compatibility, and budget for adapters if needed. The goal is seamless travel with your infant, not post-purchase scrambling for compatibility solutions.`}};var d=a.i(84686),e=a.i(95936);async function f(){return Object.keys(c).map(a=>({slug:a}))}async function g({params:a},b){let d=(await a).slug,e=c[d]||null;return e?{title:`${e.title} | The Family Pick`,description:e.description,openGraph:{title:e.title,description:e.description,type:"article",url:`https://thefamilypick.com/strollers/${d}`}}:{title:"Article Not Found"}}async function h({params:a}){let f=(await a).slug,g=c[f]||null;if(!g)return(0,b.jsxs)("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12",children:[(0,b.jsx)("h1",{className:"text-2xl font-bold text-gray-900",children:"Article not found"}),(0,b.jsx)("p",{className:"text-gray-600 mt-4",children:(0,b.jsx)(e.default,{href:"/strollers",className:"text-blue-600 hover:underline",children:"Back to strollers"})})]});let h=g.content.split("\n").map(a=>a.startsWith("## ")?`<h2 class="text-2xl font-bold text-gray-900 mt-8 mb-4">${a.replace("## ","")}</h2>`:a.startsWith("### ")?`<h3 class="text-xl font-bold text-gray-900 mt-6 mb-3">${a.replace("### ","")}</h3>`:""===a.trim()?"<br />":`<p class="text-gray-600 mb-4">${a}</p>`).join("\n");return(0,b.jsxs)("article",{className:"bg-white",children:[(0,b.jsx)("div",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-6",children:(0,b.jsx)(d.default,{items:[{label:"Strollers",href:"/strollers"},{label:g.title,href:`/strollers/${f}`}]})}),(0,b.jsxs)("section",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-b border-gray-200",children:[(0,b.jsx)("h1",{className:"text-4xl font-bold text-gray-900 mb-4",children:g.title}),(0,b.jsx)("p",{className:"text-lg text-gray-600",children:g.description})]}),(0,b.jsx)("section",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12",children:(0,b.jsx)("div",{className:"prose prose-lg max-w-none",dangerouslySetInnerHTML:{__html:h}})}),(0,b.jsxs)("section",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-t border-gray-200",children:[(0,b.jsx)("p",{className:"text-gray-600 text-sm mb-6",children:"This stroller guide was prepared with AI-assisted research. All information is based on manufacturer specifications and current market data. Prices and availability may change. For the most current information, please visit the manufacturers' websites or Amazon product pages."}),(0,b.jsx)(e.default,{href:"/strollers",className:"inline-block px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition",children:"Back to Stroller Comparison"})]})]})}a.s(["default",()=>h,"generateMetadata",()=>g,"generateStaticParams",()=>f],52953)}];

//# sourceMappingURL=src_app_strollers_%5Bslug%5D_page_tsx_90ee734f._.js.map