module.exports=[50188,a=>{"use strict";var b=a.i(7997);let c={"hepa-filter-types-explained":{slug:"hepa-filter-types-explained",title:"HEPA Filter Types Explained: H11 vs H13 vs H14",description:"Understand HEPA filter classifications, particle capture rates, and when medical-grade filtration truly matters for your home.",category:"air-purifiers",content:`## Introduction
...
A non-smart purifier from a trusted brand (Coway, Blueair, IQAir) delivers the same clean air at lower cost and no privacy concerns. The core function—filtering air—is identical whether the app exists or not.`}};var d=a.i(84686),e=a.i(16472),f=a.i(95936);async function g(){return Object.keys(c).map(a=>({slug:a}))}async function h({params:a},b){let d=(await a).slug,e=c[d]||null;return e?{title:`${e.title} | The Family Pick`,description:e.description,openGraph:{title:e.title,description:e.description,type:"article",url:`https://thefamilypick.com/air-purifiers/${d}`}}:{title:"Article Not Found"}}async function i({params:a}){let g=(await a).slug,h=c[g]||null;return h?(0,b.jsxs)("div",{className:"bg-white",children:[(0,b.jsx)("div",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-6",children:(0,b.jsx)(d.default,{items:[{label:"Air Purifiers",href:"/air-purifiers"},{label:h.title,href:`/air-purifiers/${g}`}]})}),(0,b.jsxs)("article",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12",children:[(0,b.jsxs)("header",{className:"mb-8",children:[(0,b.jsx)("h1",{className:"text-4xl font-bold text-gray-900 mb-4",children:h.title}),(0,b.jsx)("p",{className:"text-xl text-gray-600",children:h.description})]}),(0,b.jsx)("div",{className:"prose prose-lg max-w-none text-gray-700 mb-8",dangerouslySetInnerHTML:{__html:h.content}})]}),(0,b.jsx)(e.default,{pagePath:`/air-purifiers/${g}`,siteName:"thefamilypick"}),(0,b.jsxs)("section",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-t border-gray-200",children:[(0,b.jsx)("h2",{className:"text-2xl font-bold text-gray-900 mb-6",children:"Related Articles"}),(0,b.jsx)(f.default,{href:"/air-purifiers",className:"text-blue-600 hover:underline",children:"← Back to Air Purifiers"})]})]}):(0,b.jsxs)("div",{className:"max-w-4xl mx-auto px-4 py-12",children:[(0,b.jsx)("h1",{className:"text-3xl font-bold text-gray-900",children:"Article Not Found"}),(0,b.jsx)("p",{className:"text-gray-600 mt-2",children:"The article you're looking for doesn't exist."}),(0,b.jsx)(f.default,{href:"/air-purifiers",className:"text-blue-600 hover:underline mt-4 inline-block",children:"Back to Air Purifiers"})]})}a.s(["default",()=>i,"generateMetadata",()=>h,"generateStaticParams",()=>g],50188)}];

//# sourceMappingURL=src_app_air-purifiers_%5Bslug%5D_page_tsx_deefaa68._.js.map