...
Start with audio. If you find yourself wishing you could see your baby or you're away from home frequently, upgrade to video. Most parents never regret starting simple; many regret over-complicating their monitoring setup.`}};var h=a.i(68114);function i(){let[a,i]=(0,c.useState)("all"),[j,k]=(0,c.useState)("all"),[l,m]=(0,c.useState)("all"),[n,o]=(0,c.useState)("all"),[p,q]=(0,c.useState)("all"),[r,s]=(0,c.useState)("name"),t=Object.keys(g),u=(0,c.useMemo)(()=>{let b=[...e];if("all"!==a&&(b=b.filter(b=>b.monitorType===a)),"all"!==j){let a="yes"===j;b=b.filter(b=>b.wifiRequired===a)}if("all"!==n){let a="yes"===n;b=b.filter(b=>b.panTiltZoom===a)}if("all"!==p){let a="yes"===p;b=b.filter(b=>b.hasApp===a)}return"all"!==l&&("budget"===l?b=b.filter(a=>a.price<150):"mid"===l?b=b.filter(a=>a.price>=150&&a.price<250):"premium"===l&&(b=b.filter(a=>a.price>=250))),"price-low"===r?b.sort((a,b)=>a.price-b.price):"price-high"===r?b.sort((a,b)=>b.price-a.price):"rating"===r?b.sort((a,b)=>b.rating-a.rating):b.sort((a,b)=>`${a.brand} ${a.model}`.localeCompare(`${b.brand} ${b.model}`)),b},[a,j,l,n,p,r]);return(0,b.jsxs)("div",{className:"bg-white",children:[(0,b.jsx)("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6",children:(0,b.jsx)(d.default,{items:[{label:"Baby Monitors",href:"/baby-monitors"}]})}),(0,b.jsxs)("section",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12",children:[(0,b.jsx)("h1",{className:"text-4xl font-bold text-gray-900 mb-4",children:"Best Baby Monitors Compared — 2025-2026"}),(0,b.jsx)("p",{className:"text-lg text-gray-600 mb-6",children:"We've analyzed 13 baby monitors across all types and price points—from budget audio-only monitors to premium WiFi systems with AI sleep tracking. Compare specifications, features, prices, and ratings to find the monitor that matches your family's needs, privacy preferences, and budget."}),(0,b.jsx)("p",{className:"text-base text-gray-600 mb-6",children:"Our methodology is based on manufacturer specifications, user ratings, security certifications, and real-world performance data."})]}),t.length>0&&(0,b.jsxs)("section",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-t border-gray-200",children:[(0,b.jsx)("h2",{className:"text-2xl font-bold text-gray-900 mb-6",children:"Helpful Guides"}),(0,b.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-6",children:t.map(a=>(0,b.jsxs)(f.default,{href:`/baby-monitors/${a}`,className:"p-4 border border-gray-200 rounded-lg hover:border-blue-500 hover:shadow-md transition",children:[(0,b.jsx)("h3",{className:"font-semibold text-blue-600 hover:underline",children:{"wifi-vs-non-wifi-baby-monitor":"WiFi vs Non-WiFi Baby Monitors: Privacy and Security","best-baby-monitors-for-twins":"Best Baby Monitors for Twins: Multi-Camera Guide","baby-monitor-security-guide":"Baby Monitor Security: Encryption and Hacking Prevention","smart-baby-monitor-features-worth-paying-for":"Smart Features Worth Paying For vs Marketing Hype"}[a]||a}),(0,b.jsx)("p",{className:"text-sm text-gray-600 mt-1",children:"Read our in-depth guide →"})]},a))})]}),(0,b.jsx)("section",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-t border-gray-200",children:(0,b.jsxs)("div",{className:"bg-white border border-gray-200 rounded-lg p-6 mb-8",children:[(0,b.jsx)("h2",{className:"font-bold text-lg text-gray-900 mb-6",children:"Filters & Sort"}),(0,b.jsxs)("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4",children:[(0,b.jsxs)("div",{children:[(0,b.jsx)("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:"Monitor Type"}),(0,b.jsxs)("select",{value:a,onChange:a=>i(a.target.value),className:"w-full px-3 py-2 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500",children:[(0,b.jsx)("option",{value:"all",children:"All Types"}),(0,b.jsx)("option",{value:"audio",children:"Audio Only"}),(0,b.jsx)("option",{value:"video",children:"Video Monitor"}),(0,b.jsx)("option",{value:"smart",children:"Smart WiFi"}),(0,b.jsx)("option",{value:"wearable",children:"Wearable (with sensor)"})]})]}),(0,b.jsxs)("div",{children:[(0,b.jsx)("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:"WiFi Required"}),(0,b.jsxs)("select",{value:j,onChange:a=>k(a.target.value),className:"w-full px-3 py-2 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500",children:[(0,b.jsx)("option",{value:"all",children:"All"}),(0,b.jsx)("option",{value:"yes",children:"WiFi Required"}),(0,b.jsx)("option",{value:"no",children:"Closed System (No WiFi)"})]})]}),(0,b.jsxs)("div",{children:[(0,b.jsx)("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:"Pan/Tilt/Zoom"}),(0,b.jsxs)("select",{value:n,onChange:a=>o(a.target.value),className:"w-full px-3 py-2 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500",children:[(0,b.jsx)("option",{value:"all",children:"All"}),(0,b.jsx)("option",{value:"yes",children:"Pan/Tilt/Zoom"}),(0,b.jsx)("option",{value:"no",children:"Fixed Camera"})]})]}),(0,b.jsxs)("div",{children:[(0,b.jsx)("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:"Mobile App Control"}),(0,b.jsxs)("select",{value:p,onChange:a=>q(a.target.value),className:"w-full px-3 py-2 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500",children:[(0,b.jsx)("option",{value:"all",children:"All"}),(0,b.jsx)("option",{value:"yes",children:"Has App"}),(0,b.jsx)("option",{value:"no",children:"No App"})]})]}),(0,b.jsxs)("div",{children:[(0,b.jsx)("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:"Price Range"}),(0,b.jsxs)("select",{value:l,onChange:a=>m(a.target.value),className:"w-full px-3 py-2 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500",children:[(0,b.jsx)("option",{value:"all",children:"All Prices"}),(0,b.jsx)("option",{value:"budget",children:"Budget (< $150)"}),(0,b.jsx)("option",{value:"mid",children:"Mid-Range ($150-$250)"}),(0,b.jsx)("option",{value:"premium",children:"Premium (> $250)"})]})]}),(0,b.jsxs)("div",{children:[(0,b.jsx)("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:"Sort By"}),(0,b.jsxs)("select",{value:r,onChange:a=>s(a.target.value),className:"w-full px-3 py-2 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500",children:[(0,b.jsx)("option",{value:"name",children:"Brand & Model A-Z"}),(0,b.jsx)("option",{value:"price-low",children:"Price: Low to High"}),(0,b.jsx)("option",{value:"price-high",children:"Price: High to Low"}),(0,b.jsx)("option",{value:"rating",children:"Highest Rated"})]})]})]}),(0,b.jsxs)("p",{className:"text-sm text-gray-600 mt-4",children:["Showing ",u.length," of ",e.length," baby monitors"]})]})}),(0,b.jsxs)("section",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8",children:[(0,b.jsx)("h2",{className:"text-2xl font-bold text-gray-900 mb-6",children:"Full Comparison Table"}),(0,b.jsx)("div",{className:"overflow-x-auto border border-gray-200 rounded-lg",children:(0,b.jsxs)("table",{className:"w-full text-sm",children:[(0,b.jsx)("thead",{className:"bg-gray-50 border-b border-gray-200",children:(0,b.jsxs)("tr",{children:[(0,b.jsx)("th",{className:"px-4 py-3 text-left font-semibold text-gray-900",children:"Brand & Model"}),(0,b.jsx)("th",{className:"px-4 py-3 text-left font-semibold text-gray-900",children:"Type"}),(0,b.jsx)("th",{className:"px-4 py-3 text-left font-semibold text-gray-900",children:"Price"}),(0,b.jsx)("th",{className:"px-4 py-3 text-left font-semibold text-gray-900",children:"Rating"}),(0,b.jsx)("th",{className:"px-4 py-3 text-left font-semibold text-gray-900",children:"Resolution"}),(0,b.jsx)("th",{className:"px-4 py-3 text-left font-semibold text-gray-900",children:"WiFi"}),(0,b.jsx)("th",{className:"px-4 py-3 text-left font-semibold text-gray-900",children:"PTZ"}),(0,b.jsx)("th",{className:"px-4 py-3 text-left font-semibold text-gray-900",children:"Features"}),(0,b.jsx)("th",{className:"px-4 py-3 text-left font-semibold text-gray-900",children:"Amazon Link"})]})}),(0,b.jsx)("tbody",{children:u.map(a=>{let c=(0,h.getAmazonLink)(a.amazonAsin),d=[a.nightVision&&"Night Vision",a.twoWayAudio&&"Two-Way Audio",a.temperatureSensor&&"Temp Sensor",a.panTiltZoom&&"Pan/Tilt/Zoom"].filter(Boolean).join(", ");return(0,b.jsxs)("tr",{className:"border-b border-gray-200 hover:bg-gray-50",children:[(0,b.jsxs)("td",{className:"px-4 py-3 text-gray-900 font-medium",children:[a.brand," ",a.model]}),(0,b.jsx)("td",{className:"px-4 py-3 text-gray-600 capitalize",children:a.monitorType}),(0,b.jsx)("td",{className:"px-4 py-3 text-gray-900 font-semibold",children:(0,h.formatPrice)(a.price)}),(0,b.jsx)("td",{className:"px-4 py-3",children:(0,b.jsxs)("span",{className:"inline-flex items-center px-2.5 py-0.5 rounded-full text-sm font-medium bg-yellow-100 text-yellow-800",children:["★ ",(0,h.formatRating)(a.rating)]})}),(0,b.jsx)("td",{className:"px-4 py-3 text-gray-600",children:a.resolution||"N/A"}),(0,b.jsx)("td",{className:"px-4 py-3",children:(0,b.jsx)("span",{className:`inline-flex px-2 py-1 text-xs font-semibold rounded ${a.wifiRequired?"bg-blue-100 text-blue-800":"bg-green-100 text-green-800"}`,children:a.wifiRequired?"WiFi":"No WiFi"})}),(0,b.jsx)("td",{className:"px-4 py-3",children:a.panTiltZoom?(0,b.jsx)("span",{className:"text-green-600 font-medium",children:"✓"}):(0,b.jsx)("span",{className:"text-gray-400",children:"—"})}),(0,b.jsx)("td",{className:"px-4 py-3 text-gray-600 text-xs",children:d}),(0,b.jsx)("td",{className:"px-4 py-3",children:c?(0,b.jsx)("a",{href:c,target:"_blank",rel:"noopener noreferrer",className:"text-blue-600 hover:underline font-medium",children:"View on Amazon →"}):(0,b.jsx)("span",{className:"text-gray-400",children:"N/A"})})]},a.id)})})]})})]}),(0,b.jsxs)("section",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-t border-gray-200",children:[(0,b.jsx)("h2",{className:"text-2xl font-bold text-gray-900 mb-8",children:"Detailed Product Reviews"}),(0,b.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6",children:u.map(a=>{let c=(0,h.getAmazonLink)(a.amazonAsin);return(0,b.jsxs)("div",{className:"border border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition",children:[(0,b.jsx)("div",{className:"bg-gray-100 h-48 flex items-center justify-center",children:(0,b.jsx)("img",{src:a.imageUrl,alt:`${a.brand} ${a.model}`,className:"w-full h-full object-cover",onError:a=>{a.target.src="https://images.unsplash.com/photo-1585691261385-35c1ad5f9e3e?w=400"}})}),(0,b.jsxs)("div",{className:"p-4",children:[(0,b.jsxs)("h3",{className:"font-bold text-lg text-gray-900 mb-1",children:[a.brand," ",a.model]}),(0,b.jsxs)("div",{className:"flex items-center justify-between mb-3",children:[(0,b.jsx)("span",{className:"text-2xl font-bold text-gray-900",children:(0,h.formatPrice)(a.price)}),(0,b.jsxs)("span",{className:"inline-flex items-center px-2.5 py-0.5 rounded-full text-sm font-semibold bg-yellow-100 text-yellow-800",children:["★ ",(0,h.formatRating)(a.rating)]})]}),(0,b.jsx)("p",{className:"text-sm text-gray-600 mb-4 line-clamp-3",children:a.summary}),(0,b.jsxs)("div",{className:"space-y-2 mb-4 text-xs text-gray-700",children:[(0,b.jsxs)("div",{children:[(0,b.jsx)("strong",{children:"Type:"})," ",(0,b.jsx)("span",{className:"capitalize",children:a.monitorType})]}),(0,b.jsxs)("div",{children:[(0,b.jsx)("strong",{children:"Resolution:"})," ",a.resolution||"N/A"]}),(0,b.jsxs)("div",{children:[(0,b.jsx)("strong",{children:"Range:"})," ",a.range]}),(0,b.jsxs)("div",{children:[(0,b.jsx)("strong",{children:"Encryption:"})," ",a.encryption]})]}),(0,b.jsx)("div",{className:"grid grid-cols-2 gap-2 mb-4 text-xs",children:[{label:"Night Vision",value:a.nightVision},{label:"2-Way Audio",value:a.twoWayAudio},{label:"Temp Sensor",value:a.temperatureSensor},{label:"Lullabies",value:a.lullabies},{label:"Pan/Tilt/Zoom",value:a.panTiltZoom},{label:"App Control",value:a.hasApp}].map(a=>(0,b.jsxs)("div",{className:"flex items-center",children:[(0,b.jsx)("span",{className:a.value?"text-green-600 font-bold mr-1":"text-gray-400 mr-1",children:a.value?"✓":"—"}),(0,b.jsx)("span",{className:"text-gray-600",children:a.label})]},a.label))}),c&&(0,b.jsx)("a",{href:c,target:"_blank",rel:"noopener noreferrer",className:"block w-full px-4 py-2 bg-blue-600 text-white text-center font-semibold rounded hover:bg-blue-700 transition",children:"View on Amazon"})]})]},a.id)})})]}),(0,b.jsx)("section",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-t border-gray-200",children:(0,b.jsx)("div",{className:"bg-blue-50 border border-blue-200 rounded-lg p-6",children:(0,b.jsxs)("p",{className:"text-sm text-gray-600",children:[(0,b.jsx)("strong",{children:"Disclaimer:"})," This comparison and analysis was prepared with AI-assisted research. All prices, specifications, and ratings are current as of 2025-2026 and based on manufacturer data and user reviews. Prices and availability may vary by retailer. Please verify product details on Amazon before purchasing. We earn affiliate commissions on qualifying purchases at no additional cost to you."]})})})]})}a.s(["default",()=>i],88104)}];

//# sourceMappingURL=src_app_baby-monitors_page_tsx_5dbef32a._.js.map