...
Start with your base stroller and identify actual friction points over the first month. Then invest in accessories that address those specific problems. Most parents find that 3-4 well-chosen accessories dramatically improve their strolling experience without cluttering their setup.`}};var d=a.i(84686),e=a.i(16472),f=a.i(95936);async function g(){return Object.keys(c).map(a=>({slug:a}))}async function h({params:a},b){let d=(await a).slug,e=c[d]||null;return e?{title:`${e.title} | The Family Pick`,description:e.description,openGraph:{title:e.title,description:e.description,type:"article",url:`https://thefamilypick.com/strollers/${d}`}}:{title:"Article Not Found"}}async function i({params:a}){let g=(await a).slug,h=c[g]||null;if(!h)return(0,b.jsxs)("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12",children:[(0,b.jsx)("h1",{className:"text-2xl font-bold text-gray-900",children:"Article not found"}),(0,b.jsx)("p",{className:"text-gray-600 mt-4",children:(0,b.jsx)(f.default,{href:"/strollers",className:"text-blue-600 hover:underline",children:"Back to strollers"})})]});let i=h.content.split("\n").map(a=>a.startsWith("## ")?`<h2 class="text-2xl font-bold text-gray-900 mt-8 mb-4">${a.replace("## ","")}</h2>`:a.startsWith("### ")?`<h3 class="text-xl font-bold text-gray-900 mt-6 mb-3">${a.replace("### ","")}</h3>`:""===a.trim()?"<br />":`<p class="text-gray-600 mb-4">${a}</p>`).join("\n");return(0,b.jsxs)("article",{className:"bg-white",children:[(0,b.jsx)("div",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-6",children:(0,b.jsx)(d.default,{items:[{label:"Strollers",href:"/strollers"},{label:h.title,href:`/strollers/${g}`}]})}),(0,b.jsxs)("section",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-b border-gray-200",children:[(0,b.jsx)("h1",{className:"text-4xl font-bold text-gray-900 mb-4",children:h.title}),(0,b.jsx)("p",{className:"text-lg text-gray-600",children:h.description})]}),(0,b.jsx)("section",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12",children:(0,b.jsx)("div",{className:"prose prose-lg max-w-none",dangerouslySetInnerHTML:{__html:i}})}),(0,b.jsxs)("section",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-t border-gray-200",children:[(0,b.jsx)("p",{className:"text-gray-600 text-sm mb-6",children:"This stroller guide was prepared with AI-assisted research. All information is based on manufacturer specifications and current market data. Prices and availability may change. For the most current information, please visit the manufacturers' websites or Amazon product pages."}),(0,b.jsx)(f.default,{href:"/strollers",className:"inline-block px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition",children:"Back to Stroller Comparison"})]}),(0,b.jsx)(e.default,{pagePath:`/strollers/${g}`,siteName:"thefamilypick"})]})}a.s(["default",()=>i,"generateMetadata",()=>h,"generateStaticParams",()=>g],52953)}];
