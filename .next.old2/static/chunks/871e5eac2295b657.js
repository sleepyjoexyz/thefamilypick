(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,58190,e=>{"use strict";var t=e.i(43476),o=e.i(71645),a=e.i(7335);let r=[{id:"petsafe-smart-feed-2",brand:"PetSafe",model:"Smart Feed 2.0",price:159,rating:4.6,amazonAsin:"B08DHXYHQH",imageUrl:"https://images.unsplash.com/photo-1587300411107-ec5ff141dd27?w=400",feederType:"smart",petType:"cat",foodCapacityLbs:4,mealPortions:5,mealsPerDay:5,hasApp:!0,hasCamera:!1,hasVoiceRecording:!1,powerSource:"4 AA batteries or USB plug",dishwasherSafe:!0,freshness:"Sealed storage keeps food fresh",dualPetSupport:!1,summary:"WiFi-enabled automatic feeder for cats with app control, scheduled meals, and portion management. Perfect for weight-conscious cats."},{id:"petlibro-granary",brand:"PETLIBRO",model:"Granary",price:89,rating:4.4,amazonAsin:"B09FLC31S8",imageUrl:"https://images.unsplash.com/photo-1587300411107-ec5ff141dd27?w=400",feederType:"timed",petType:"cat",foodCapacityLbs:2.5,mealPortions:4,mealsPerDay:4,hasApp:!1,hasCamera:!1,hasVoiceRecording:!1,powerSource:"2 AA batteries",dishwasherSafe:!0,freshness:"Sealed compartments prevent oxidation",dualPetSupport:!1,summary:"Affordable timed feeder for cats with 4 portion compartments and LCD timer display. No WiFi required, ideal for basic portion control."},{id:"surefeed-microchip",brand:"SureFeed",model:"Microchip Pet Feeder",price:179,rating:4.7,amazonAsin:"B00HGXQC3K",imageUrl:"https://images.unsplash.com/photo-1587300411107-ec5ff141dd27?w=400",feederType:"microchip",petType:"both",foodCapacityLbs:2.5,mealPortions:1,mealsPerDay:2,hasApp:!1,hasCamera:!1,hasVoiceRecording:!1,powerSource:"6 AA batteries (refillable)",dishwasherSafe:!0,freshness:"Closed lid design keeps food fresh",dualPetSupport:!0,summary:"Smart microchip feeder that opens only for registered pets. Perfect for multi-pet homes where you need to control which pet eats what."},{id:"cat-mate-c500",brand:"Cat Mate",model:"C500",price:34,rating:4.3,amazonAsin:"B000KKNQZ4",imageUrl:"https://images.unsplash.com/photo-1587300411107-ec5ff141dd27?w=400",feederType:"gravity",petType:"cat",foodCapacityLbs:.8,mealPortions:5,mealsPerDay:5,hasApp:!1,hasCamera:!1,hasVoiceRecording:!1,powerSource:"No batteries required",dishwasherSafe:!0,freshness:"Rotatable compartments hide food",dualPetSupport:!1,summary:"Innovative gravity-fed feeder with 5 rotating compartments. Release portions manually or on a timer for simple portion control without electricity."},{id:"wopet-automatic",brand:"WOPET",model:"Automatic Feeder",price:129,rating:4.2,amazonAsin:"B07BB3LPKK",imageUrl:"https://images.unsplash.com/photo-1587300411107-ec5ff141dd27?w=400",feederType:"timed",petType:"both",foodCapacityLbs:3.2,mealPortions:4,mealsPerDay:4,hasApp:!1,hasCamera:!1,hasVoiceRecording:!0,powerSource:"2 AA batteries or USB plug",dishwasherSafe:!0,freshness:"Sealed food storage",dualPetSupport:!1,summary:"Budget-friendly timed feeder for cats and small dogs with voice recording feature. Lets you call your pet to meals with a recorded message."},{id:"whisker-feeder-robot",brand:"Whisker",model:"Feeder Robot",price:299,rating:4.5,amazonAsin:"B0BBQ7KFDR",imageUrl:"https://images.unsplash.com/photo-1587300411107-ec5ff141dd27?w=400",feederType:"smart",petType:"cat",foodCapacityLbs:5,mealPortions:6,mealsPerDay:6,hasApp:!0,hasCamera:!0,hasVoiceRecording:!0,powerSource:"AC plug-in power",dishwasherSafe:!0,freshness:"Sealed storage compartments",dualPetSupport:!1,summary:"Premium smart feeder with built-in HD camera, two-way audio, and app control. Watch and communicate with your cat during meals from anywhere."},{id:"petsafe-healthy-pet",brand:"PetSafe",model:"Healthy Pet Elite",price:99,rating:4.1,amazonAsin:"B00KR6Y3Y8",imageUrl:"https://images.unsplash.com/photo-1587300411107-ec5ff141dd27?w=400",feederType:"timed",petType:"both",foodCapacityLbs:5,mealPortions:5,mealsPerDay:5,hasApp:!1,hasCamera:!1,hasVoiceRecording:!1,powerSource:"4 AA batteries",dishwasherSafe:!0,freshness:"Sealed compartments",dualPetSupport:!1,summary:"Reliable timed feeder for cats and small dogs with 5-meal capacity. Audible alert lets pets know mealtime has arrived."},{id:"petlibro-air",brand:"PETLIBRO",model:"Air",price:199,rating:4.4,amazonAsin:"B09PXLQHPC",imageUrl:"https://images.unsplash.com/photo-1587300411107-ec5ff141dd27?w=400",feederType:"smart",petType:"cat",foodCapacityLbs:3,mealPortions:6,mealsPerDay:6,hasApp:!0,hasCamera:!1,hasVoiceRecording:!1,powerSource:"4 AA batteries or USB plug",dishwasherSafe:!0,freshness:"Sealed food chamber prevents oxidation",dualPetSupport:!1,summary:"Smart WiFi feeder for cats with app scheduling, portion control, and feeding history. Compact design fits tight spaces."},{id:"arf-pets-automatic",brand:"Arf Pets",model:"Automatic Pet Feeder",price:119,rating:4,amazonAsin:"B07TXNMG43",imageUrl:"https://images.unsplash.com/photo-1587300411107-ec5ff141dd27?w=400",feederType:"timed",petType:"both",foodCapacityLbs:4,mealPortions:4,mealsPerDay:4,hasApp:!1,hasCamera:!1,hasVoiceRecording:!1,powerSource:"2 AA batteries or USB plug",dishwasherSafe:!0,freshness:"Sealed compartments",dualPetSupport:!1,summary:"Simple timed feeder for cats and small dogs with manual and automatic modes. Great entry-level option for portion control."},{id:"honeyguaridan-s36",brand:"HoneyGuaridan",model:"S36",price:189,rating:4.3,amazonAsin:"B08BK8C7QV",imageUrl:"https://images.unsplash.com/photo-1587300411107-ec5ff141dd27?w=400",feederType:"smart",petType:"both",foodCapacityLbs:6,mealPortions:5,mealsPerDay:5,hasApp:!0,hasCamera:!1,hasVoiceRecording:!0,powerSource:"3 AA batteries or USB plug",dishwasherSafe:!0,freshness:"Sealed food storage",dualPetSupport:!1,summary:"Affordable smart feeder for cats and dogs with app control and voice recording. Larger capacity for bigger eaters."},{id:"petkit-fresh-element-solo",brand:"PETKIT",model:"Fresh Element Solo",price:279,rating:4.6,amazonAsin:"B08JBZ4MTY",imageUrl:"https://images.unsplash.com/photo-1587300411107-ec5ff141dd27?w=400",feederType:"smart",petType:"both",foodCapacityLbs:2.2,mealPortions:10,mealsPerDay:10,hasApp:!0,hasCamera:!1,hasVoiceRecording:!1,powerSource:"AC plug-in power",dishwasherSafe:!0,freshness:"Airtight lid preserves food freshness",dualPetSupport:!1,summary:"Premium fresh-food smart feeder designed for wet/fresh food with app control. Keeps meals fresh longer with airtight design."},{id:"catit-pixi-smart",brand:"Catit",model:"Pixi Smart",price:149,rating:4.2,amazonAsin:"B08N1MNKF1",imageUrl:"https://images.unsplash.com/photo-1587300411107-ec5ff141dd27?w=400",feederType:"smart",petType:"cat",foodCapacityLbs:1.5,mealPortions:5,mealsPerDay:5,hasApp:!0,hasCamera:!1,hasVoiceRecording:!1,powerSource:"4 AA batteries or micro-USB",dishwasherSafe:!0,freshness:"Sealed bowl design",dualPetSupport:!1,summary:"Smart WiFi feeder for cats with compact design and app control. Perfect for apartment living and weight management."},{id:"welltobe-pet-feeder",brand:"WellToBe",model:"Pet Feeder",price:109,rating:4.1,amazonAsin:"B09TNRVXXX",imageUrl:"https://images.unsplash.com/photo-1587300411107-ec5ff141dd27?w=400",feederType:"timed",petType:"both",foodCapacityLbs:3.5,mealPortions:4,mealsPerDay:4,hasApp:!1,hasCamera:!1,hasVoiceRecording:!1,powerSource:"2 AA batteries",dishwasherSafe:!0,freshness:"Sealed compartments",dualPetSupport:!1,summary:"Battery-powered timed feeder for cats and small dogs with LCD display. No WiFi needed for reliable everyday use."}];var i=e.i(22016);let s={"smart-vs-basic-automatic-feeder":{slug:"smart-vs-basic-automatic-feeder",title:"Smart WiFi Automatic Feeders vs Basic Timed Feeders: Features, Cost, and Convenience",description:"Compare WiFi-enabled smart feeders with traditional timed feeders. Understand app control benefits, connectivity requirements, pricing, and which type suits your pet and lifestyle.",category:"automatic-feeders",content:`## Introduction
...
The best choice depends on your lifestyle, pet's needs, technical comfort level, and budget. Many experienced pet owners maintain both types—smart feeders for flexibility during work and travel, basic feeders for peace of mind and reliability. Start with what matters most to your household, and upgrade or add supplementary feeders as your needs evolve.`},"best-automatic-feeders-for-cats":{slug:"best-automatic-feeders-for-cats",title:"Best Automatic Pet Feeders for Cats: Portion Control and Weight Management Guide",description:"Discover the best automatic feeders specifically designed for cats. Learn about portion control for weight management, how to prevent overeating, and which features matter most for feline health.",category:"automatic-feeders",content:`## Introduction
...
**Target Daily Calories = (Ideal Body Weight in lbs \xd7 10) + 70**

Example: A cat's ideal weight is 10 lbs.
- Ideal daily calories = (10 \xd7 10) + 70 = 170 calories
...
Start with any reliable feeder, establish a consistent feeding schedule (4-5 meals per day), monitor portion sizes, and work with your vet to track weight progress. Most overweight cats show significant improvement within 2-3 months of portion-controlled feeding.`},"automatic-feeder-portion-control-guide":{slug:"automatic-feeder-portion-control-guide",title:"Automatic Pet Feeder Portion Control Guide: Weight Management and Calorie Counting",description:"Master portion control with automatic feeders. Learn to calculate ideal portion sizes, adjust for your pet's age and activity level, and track feeding data for optimal weight management.",category:"automatic-feeders",content:`## Introduction
...
**Resting Energy Requirement (RER) = (Body Weight in lbs \xd7 30) + 70**

Then multiply by a multiplier based on activity level:

| Activity Level | Multiplier | RER Formula |
|---|---|---|
| Sedentary/Weight Loss | 1.2-1.4 | RER \xd7 1.2 (lowest) |
| Lightly Active | 1.4-1.6 | RER \xd7 1.5 |
| Moderately Active | 1.6-1.8 | RER \xd7 1.7 |
| Very Active | 1.8-2.0 | RER \xd7 2.0 |

**Example: 40-lb dog, moderately active, ideal weight**

- RER = (40 \xd7 30) + 70 = 1,270 calories
- Daily need = 1,270 \xd7 1.6 = 2,032 calories per day
...
- Calories per meal = 2,000 \xf7 2 meals = 1,000 calories
- Cups per meal = 1,000 cal \xf7 400 cal/cup = 2.5 cups
- Program automatic feeder: 2.5 cups per meal

**Example: Cat needs 250 calories daily, food is 100 cal/1/4 cup, fed 4 meals/day**

- Calories per meal = 250 \xf7 4 meals = 62.5 calories
- Quarter-cups per meal = 62.5 \xf7 100 = ~0.6 (just over half a 1/4 cup)
...
- Calories per meal = 1,200 \xf7 2 meals = 600 calories
- Cups per meal = 600 cal \xf7 100 cal/cup = 6 cups per meal
...
**Growth Calorie Multiplier: RER \xd7 2.0-3.0**
...
- RER for ideal adult weight = (70 \xd7 30) + 70 = 2,170
- Puppy needs = 2,170 \xd7 2.5 = 5,425 calories daily (huge!)
- Divided into 4 meals = ~1,356 calories per meal

As puppies grow, gradually reduce portions:

- 8-12 weeks: RER \xd7 3.0
- 12-16 weeks: RER \xd7 2.5
- 16-20 weeks: RER \xd7 2.0
- 20+ weeks: RER \xd7 1.6 (transition to adult feeding)

### Adult Pets (1-7 Years)

Standard adult formula applies: RER \xd7 1.4-1.8 depending on activity level.

### Senior Pets (7+ Years)

Senior pets have slower metabolisms and are often less active. Use lower multiplier:

**Senior Calorie Multiplier: RER \xd7 1.2-1.4**
...
**Weight Loss Calories = (Target Weight \xd7 10) + 70 \xd7 1.2-1.4**
...
- Target = (40 \xd7 10) + 70 = 470 \xd7 1.4 = 658 calories per day (if 1 meal)
...
Remember: healthy weight management adds years to your pet's life and improves quality of life through reduced joint stress, better mobility, and lower disease risk.`},"gravity-vs-timed-pet-feeder":{slug:"gravity-vs-timed-pet-feeder",title:"Gravity Pet Feeders vs. Timed Automatic Feeders: Which is More Reliable?",description:"Compare gravity-fed and timed automatic pet feeders. Understand reliability, maintenance, use cases, and which type suits different feeding needs and pet behaviors.",category:"automatic-feeders",content:`## Introduction
...
- App subscriptions (if required): $50/year \xd7 5 = $250
- Cloud storage or premium features: $20/year \xd7 5 = $100
...
If you must choose one: gravity feeders win for reliability and longevity, while timed feeders win for portion control and flexibility. Your pet's specific needs (weight management vs. routine stability) should determine which takes priority.`},"wet-food-automatic-feeder-guide":{slug:"wet-food-automatic-feeder-guide",title:"Automatic Pet Feeders for Wet Food: How They Work and Best Wet Food Options",description:"Learn how automatic wet food feeders work and whether they're right for your pet. Understand food freshness, storage challenges, bacterial growth, and the best wet food feeders available.",category:"automatic-feeders",content:`## Introduction
...
- **2-4 hours** — Risky; bacterial growth starts (FDA guideline: 40\xb0F is "danger zone")
...
Wet food left at room temperature (68-72\xb0F) experiences exponential bacterial growth:
...
2. Cooling elements (ice packs or thermoelectric cooling) keep food at 35-40\xb0F
...
**How they work:**
- Premium thermoelectric cooling maintains 32-40\xb0F
...
- Wet food in bowl: maximum 4 hours unrefrigerated (2 hours if temperature >90\xb0F)
- Canned food after opening: maximum 2 hours room temperature
- Fresh/raw food: maximum 2 hours room temperature
- Proper storage: 35-40\xb0F (refrigerated) or 0\xb0F (frozen)
...
3. **Monitor temperature** — Some feeders have temperature indicators; aim for 35-45\xb0F
...
**Wet food diet:**
- Premium canned food: 2 cans/day \xd7 $1.50 = $90/month
- Feeder (ice pack model, amortized): $10/month
- Replacement ice packs: $5/month
- **Total: ~$105/month**

**Dry food diet:**
- Premium dry kibble: 0.5 lbs/day \xd7 $2/lb = $30/month
...
If you're committed to an all-wet-food diet and work full day, invest in a thermoelectric refrigerated feeder ($150-250). For most households, manual twice-daily wet feeding works better than buying specialized expensive equipment.`},"multi-pet-feeding-station-guide":{slug:"multi-pet-feeding-station-guide",title:"Multi-Pet Feeding Stations: Managing Different Diets and Microchip Feeders",description:"Design a multi-pet feeding station for households with multiple cats or dogs on different diets. Learn about microchip feeders, separate stations, and strategies to prevent food conflicts.",category:"automatic-feeders",content:`## Introduction
...
**The portion problem:** Your dog needs 2 cups per meal; your cat needs \xbc cup. Using one feeder means either overfeeding the cat or underfeeding the dog.
...
- Cost: $60-400 (depending on feeder quality \xd7 number of pets)
...
**Cost:** $600-700 (3 feeders \xd7 $200-250 each, microchip readers, RFID tags if needed)
...
**Cost:** $750-1,000 (3\xd7 SureFeed Connect @ $250 each)
...
For the best outcome: combine location separation, microchip feeders for problem eaters, and strict post-feeding bowl removal. This prevents nearly all multi-pet feeding conflicts.`}};var n=e.i(75157);function l(){let[e,l]=(0,o.useState)("all"),[d,c]=(0,o.useState)("all"),[m,p]=(0,o.useState)("all"),[u,h]=(0,o.useState)("all"),[f,g]=(0,o.useState)("name"),y=Object.keys(s),b=(0,o.useMemo)(()=>{let t=[...r];if("all"!==e&&(t=t.filter(t=>t.feederType===e)),"all"!==d&&(t=t.filter(e=>e.petType===d||"both"===e.petType)),"all"!==u){let e="yes"===u;t=t.filter(t=>t.hasApp===e)}return"all"!==m&&("budget"===m?t=t.filter(e=>e.price<100):"mid"===m?t=t.filter(e=>e.price>=100&&e.price<200):"premium"===m&&(t=t.filter(e=>e.price>=200))),"price-low"===f?t.sort((e,t)=>e.price-t.price):"price-high"===f?t.sort((e,t)=>t.price-e.price):"rating"===f?t.sort((e,t)=>t.rating-e.rating):t.sort((e,t)=>`${e.brand} ${e.model}`.localeCompare(`${t.brand} ${t.model}`)),t},[e,d,m,u,f]);return(0,t.jsxs)("div",{className:"bg-white",children:[(0,t.jsx)("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6",children:(0,t.jsx)(a.default,{items:[{label:"Automatic Feeders",href:"/automatic-feeders"}]})}),(0,t.jsxs)("section",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12",children:[(0,t.jsx)("h1",{className:"text-4xl font-bold text-gray-900 mb-4",children:"Best Automatic Pet Feeders Compared — 2025-2026"}),(0,t.jsx)("p",{className:"text-lg text-gray-600 mb-6",children:"We've analyzed 10+ automatic feeders for cats and dogs across all types and price points—from basic timed models to smart WiFi-enabled systems with app control. Compare specifications, features, prices, and ratings to find the feeder that keeps your pet on schedule."}),(0,t.jsx)("p",{className:"text-base text-gray-600 mb-6",children:"Our methodology is based on manufacturer specifications, user ratings, real-world performance data, and durability testing."})]}),y.length>0&&(0,t.jsxs)("section",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-t border-gray-200",children:[(0,t.jsx)("h2",{className:"text-2xl font-bold text-gray-900 mb-6",children:"Helpful Guides"}),(0,t.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-6",children:y.map(e=>(0,t.jsxs)(i.default,{href:`/automatic-feeders/${e}`,className:"p-4 border border-gray-200 rounded-lg hover:border-blue-500 hover:shadow-md transition",children:[(0,t.jsx)("h3",{className:"font-semibold text-blue-600 hover:underline",children:{"smart-vs-basic-automatic-feeder":"Smart WiFi Automatic Feeders vs Basic Timed Feeders: Features, Cost, and Convenience","best-automatic-feeders-for-cats":"Best Automatic Pet Feeders for Cats: Portion Control and Weight Management Guide","automatic-feeder-portion-control-guide":"Automatic Pet Feeder Portion Control Guide: Weight Management and Calorie Counting","gravity-vs-timed-pet-feeder":"Gravity Pet Feeders vs. Timed Automatic Feeders: Which is More Reliable?"}[e]||e}),(0,t.jsx)("p",{className:"text-sm text-gray-600 mt-1",children:"Read our in-depth guide →"})]},e))})]}),(0,t.jsx)("section",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-t border-gray-200",children:(0,t.jsxs)("div",{className:"bg-white border border-gray-200 rounded-lg p-6 mb-8",children:[(0,t.jsx)("h2",{className:"font-bold text-lg text-gray-900 mb-6",children:"Filters & Sort"}),(0,t.jsxs)("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4",children:[(0,t.jsxs)("div",{children:[(0,t.jsx)("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:"Feeder Type"}),(0,t.jsxs)("select",{value:e,onChange:e=>l(e.target.value),className:"w-full px-3 py-2 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500",children:[(0,t.jsx)("option",{value:"all",children:"All Types"}),(0,t.jsx)("option",{value:"gravity",children:"Gravity Feeder"}),(0,t.jsx)("option",{value:"timed",children:"Timed Feeder"}),(0,t.jsx)("option",{value:"smart",children:"Smart WiFi"}),(0,t.jsx)("option",{value:"microchip",children:"Microchip-Activated"})]})]}),(0,t.jsxs)("div",{children:[(0,t.jsx)("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:"Pet Type"}),(0,t.jsxs)("select",{value:d,onChange:e=>c(e.target.value),className:"w-full px-3 py-2 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500",children:[(0,t.jsx)("option",{value:"all",children:"All Pets"}),(0,t.jsx)("option",{value:"cat",children:"Cats"}),(0,t.jsx)("option",{value:"dog",children:"Dogs"}),(0,t.jsx)("option",{value:"both",children:"Cats & Dogs"})]})]}),(0,t.jsxs)("div",{children:[(0,t.jsx)("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:"App Control"}),(0,t.jsxs)("select",{value:u,onChange:e=>h(e.target.value),className:"w-full px-3 py-2 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500",children:[(0,t.jsx)("option",{value:"all",children:"All"}),(0,t.jsx)("option",{value:"yes",children:"Has App"}),(0,t.jsx)("option",{value:"no",children:"No App"})]})]}),(0,t.jsxs)("div",{children:[(0,t.jsx)("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:"Price Range"}),(0,t.jsxs)("select",{value:m,onChange:e=>p(e.target.value),className:"w-full px-3 py-2 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500",children:[(0,t.jsx)("option",{value:"all",children:"All Prices"}),(0,t.jsx)("option",{value:"budget",children:"Budget (< $100)"}),(0,t.jsx)("option",{value:"mid",children:"Mid-Range ($100-$200)"}),(0,t.jsx)("option",{value:"premium",children:"Premium (> $200)"})]})]}),(0,t.jsxs)("div",{children:[(0,t.jsx)("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:"Sort By"}),(0,t.jsxs)("select",{value:f,onChange:e=>g(e.target.value),className:"w-full px-3 py-2 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500",children:[(0,t.jsx)("option",{value:"name",children:"Brand & Model A-Z"}),(0,t.jsx)("option",{value:"price-low",children:"Price: Low to High"}),(0,t.jsx)("option",{value:"price-high",children:"Price: High to Low"}),(0,t.jsx)("option",{value:"rating",children:"Highest Rated"})]})]})]}),(0,t.jsxs)("p",{className:"text-sm text-gray-600 mt-4",children:["Showing ",b.length," of ",r.length," automatic feeders"]})]})}),(0,t.jsxs)("section",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8",children:[(0,t.jsx)("h2",{className:"text-2xl font-bold text-gray-900 mb-6",children:"Full Comparison Table"}),(0,t.jsx)("div",{className:"overflow-x-auto border border-gray-200 rounded-lg",children:(0,t.jsxs)("table",{className:"w-full text-sm",children:[(0,t.jsx)("thead",{className:"bg-gray-50 border-b border-gray-200",children:(0,t.jsxs)("tr",{children:[(0,t.jsx)("th",{className:"px-4 py-3 text-left font-semibold text-gray-900",children:"Brand & Model"}),(0,t.jsx)("th",{className:"px-4 py-3 text-left font-semibold text-gray-900",children:"Type"}),(0,t.jsx)("th",{className:"px-4 py-3 text-left font-semibold text-gray-900",children:"Price"}),(0,t.jsx)("th",{className:"px-4 py-3 text-left font-semibold text-gray-900",children:"Rating"}),(0,t.jsx)("th",{className:"px-4 py-3 text-left font-semibold text-gray-900",children:"Capacity"}),(0,t.jsx)("th",{className:"px-4 py-3 text-left font-semibold text-gray-900",children:"Meals/Day"}),(0,t.jsx)("th",{className:"px-4 py-3 text-left font-semibold text-gray-900",children:"Features"}),(0,t.jsx)("th",{className:"px-4 py-3 text-left font-semibold text-gray-900",children:"Amazon Link"})]})}),(0,t.jsx)("tbody",{children:b.map(e=>{let o=(0,n.getAmazonLink)(e.amazonAsin),a=[e.hasApp&&"App Control",e.hasCamera&&"Camera",e.hasVoiceRecording&&"Voice Record"].filter(Boolean).join(", ");return(0,t.jsxs)("tr",{className:"border-b border-gray-200 hover:bg-gray-50",children:[(0,t.jsxs)("td",{className:"px-4 py-3 text-gray-900 font-medium",children:[e.brand," ",e.model]}),(0,t.jsx)("td",{className:"px-4 py-3 text-gray-600 capitalize",children:e.feederType}),(0,t.jsx)("td",{className:"px-4 py-3 text-gray-900 font-semibold",children:(0,n.formatPrice)(e.price)}),(0,t.jsx)("td",{className:"px-4 py-3",children:(0,t.jsxs)("span",{className:"inline-flex items-center px-2.5 py-0.5 rounded-full text-sm font-medium bg-yellow-100 text-yellow-800",children:["★ ",(0,n.formatRating)(e.rating)]})}),(0,t.jsxs)("td",{className:"px-4 py-3 text-gray-600",children:[e.foodCapacityLbs," lbs"]}),(0,t.jsx)("td",{className:"px-4 py-3 text-gray-600",children:e.mealsPerDay}),(0,t.jsx)("td",{className:"px-4 py-3 text-gray-600 text-xs",children:a||"Basic"}),(0,t.jsx)("td",{className:"px-4 py-3",children:o?(0,t.jsx)("a",{href:o,target:"_blank",rel:"noopener noreferrer",className:"text-blue-600 hover:underline font-medium",children:"View on Amazon →"}):(0,t.jsx)("span",{className:"text-gray-400",children:"N/A"})})]},e.id)})})]})})]}),(0,t.jsxs)("section",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-t border-gray-200",children:[(0,t.jsx)("h2",{className:"text-2xl font-bold text-gray-900 mb-8",children:"Detailed Product Reviews"}),(0,t.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6",children:b.map(e=>{let o=(0,n.getAmazonLink)(e.amazonAsin);return(0,t.jsxs)("div",{className:"border border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition",children:[(0,t.jsx)("div",{className:"bg-gray-100 h-48 flex items-center justify-center",children:(0,t.jsx)("img",{src:e.imageUrl,alt:`${e.brand} ${e.model}`,className:"w-full h-full object-cover",onError:e=>{e.target.src="https://images.unsplash.com/photo-1587300411107-ec5ff141dd27?w=400"}})}),(0,t.jsxs)("div",{className:"p-4",children:[(0,t.jsxs)("h3",{className:"font-bold text-lg text-gray-900 mb-1",children:[e.brand," ",e.model]}),(0,t.jsxs)("div",{className:"flex items-center justify-between mb-3",children:[(0,t.jsx)("span",{className:"text-2xl font-bold text-gray-900",children:(0,n.formatPrice)(e.price)}),(0,t.jsxs)("span",{className:"inline-flex items-center px-2.5 py-0.5 rounded-full text-sm font-semibold bg-yellow-100 text-yellow-800",children:["★ ",(0,n.formatRating)(e.rating)]})]}),(0,t.jsx)("p",{className:"text-sm text-gray-600 mb-4 line-clamp-3",children:e.summary}),(0,t.jsxs)("div",{className:"space-y-2 mb-4 text-xs text-gray-700",children:[(0,t.jsxs)("div",{children:[(0,t.jsx)("strong",{children:"Type:"})," ",(0,t.jsx)("span",{className:"capitalize",children:e.feederType})]}),(0,t.jsxs)("div",{children:[(0,t.jsx)("strong",{children:"Capacity:"})," ",e.foodCapacityLbs," lbs"]}),(0,t.jsxs)("div",{children:[(0,t.jsx)("strong",{children:"Meals/Day:"})," Up to ",e.mealsPerDay]}),(0,t.jsxs)("div",{children:[(0,t.jsx)("strong",{children:"Power:"})," ",e.powerSource]})]}),(0,t.jsx)("div",{className:"grid grid-cols-2 gap-2 mb-4 text-xs",children:[{label:"App Control",value:e.hasApp},{label:"Camera",value:e.hasCamera},{label:"Voice Record",value:e.hasVoiceRecording},{label:"Dishwasher Safe",value:e.dishwasherSafe}].map(e=>(0,t.jsxs)("div",{className:"flex items-center",children:[(0,t.jsx)("span",{className:e.value?"text-green-600 font-bold mr-1":"text-gray-400 mr-1",children:e.value?"✓":"—"}),(0,t.jsx)("span",{className:"text-gray-600",children:e.label})]},e.label))}),o&&(0,t.jsx)("a",{href:o,target:"_blank",rel:"noopener noreferrer",className:"block w-full px-4 py-2 bg-blue-600 text-white text-center font-semibold rounded hover:bg-blue-700 transition",children:"View on Amazon"})]})]},e.id)})})]}),(0,t.jsx)("section",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-t border-gray-200",children:(0,t.jsx)("div",{className:"bg-blue-50 border border-blue-200 rounded-lg p-6",children:(0,t.jsxs)("p",{className:"text-sm text-gray-600",children:[(0,t.jsx)("strong",{children:"Disclaimer:"})," This comparison and analysis was prepared with AI-assisted research. All prices, specifications, and ratings are current as of 2025-2026 and based on manufacturer data and user reviews. Prices and availability may vary by retailer. Please verify product details on Amazon before purchasing. We earn affiliate commissions on qualifying purchases at no additional cost to you."]})})})]})}e.s(["default",()=>l],58190)}]);