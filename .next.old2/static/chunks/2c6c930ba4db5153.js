...
A seat with an excellent IIHS rating installed correctly will provide superior protection to an untested seat installed poorly. Buy the best-rated seat you can afford, install it correctly, and verify installation before every drive. That discipline matters more than selecting between nearly-equivalent certified seats.`}};var o=e.i(75157);function l(){let[e,l]=(0,a.useState)("all"),[c,h]=(0,a.useState)("all"),[d,g]=(0,a.useState)("all"),[m,f]=(0,a.useState)("all"),[u,p]=(0,a.useState)("name"),y=Object.keys(n),b=(0,a.useMemo)(()=>{let t=[...i];if("all"!==e&&(t=t.filter(t=>t.seatType===e)),"all"!==c){let[e,a]=c.split("-").map(Number);t=t.filter(t=>t.price>=e&&(a===1/0||t.price<=a))}return"yes"===d&&(t=t.filter(e=>!0===e.sideImpactProtection)),"all"!==m&&(t=t.filter(e=>e.installMethod.includes(m))),"price-low"===u?t.sort((e,t)=>e.price-t.price):"price-high"===u?t.sort((e,t)=>t.price-e.price):"rating"===u?t.sort((e,t)=>t.rating-e.rating):t.sort((e,t)=>`${e.brand} ${e.model}`.localeCompare(`${t.brand} ${t.model}`)),t},[e,c,d,m,u]);return(0,t.jsxs)("div",{className:"bg-white",children:[(0,t.jsx)("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6",children:(0,t.jsx)(s.default,{items:[{label:"Car Seats",href:"/car-seats"}]})}),(0,t.jsxs)("section",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12",children:[(0,t.jsx)("h1",{className:"text-4xl font-bold text-gray-900 mb-4",children:"Best Car Seats Compared — 2025-2026"}),(0,t.jsx)("p",{className:"text-lg text-gray-600 mb-6",children:"We've analyzed 14 car seats across all types, price points, and safety features. Compare specifications, installation methods, weight ranges, and ratings to find the car seat that matches your child's age, your vehicle, and your safety priorities. Our methodology is based on manufacturer specs, NHTSA safety data, and real-world user ratings."}),y.length>0&&(0,t.jsxs)("div",{className:"mt-8 bg-blue-50 border border-blue-200 rounded-lg p-6",children:[(0,t.jsx)("h3",{className:"text-lg font-semibold text-blue-900 mb-4",children:"Car Seat Guides & Articles"}),(0,t.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-3",children:y.map(e=>(0,t.jsxs)(r.default,{href:`/car-seats/${e}`,className:"text-blue-600 hover:underline text-sm",children:["→ ",{"infant-vs-convertible-car-seat":"Infant vs Convertible: Which Should You Buy?","best-car-seats-for-small-cars":"Best Car Seats for Small Cars","car-seat-installation-guide":"Car Seat Installation Guide: LATCH vs Seatbelt","when-to-switch-car-seat-stages":"When to Switch Car Seat Stages"}[e]||e]},e))})]})]}),(0,t.jsx)("section",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8",children:(0,t.jsxs)("div",{className:"bg-white border border-gray-200 rounded-lg p-6 mb-8",children:[(0,t.jsx)("h2",{className:"font-bold text-lg text-gray-900 mb-6",children:"Filters & Sort"}),(0,t.jsxs)("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4",children:[(0,t.jsxs)("div",{children:[(0,t.jsx)("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:"Seat Type"}),(0,t.jsxs)("select",{value:e,onChange:e=>l(e.target.value),className:"w-full px-3 py-2 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500",children:[(0,t.jsx)("option",{value:"all",children:"All Types"}),(0,t.jsx)("option",{value:"infant",children:"Infant"}),(0,t.jsx)("option",{value:"convertible",children:"Convertible"}),(0,t.jsx)("option",{value:"all-in-one",children:"All-in-One"}),(0,t.jsx)("option",{value:"booster",children:"Booster"})]})]}),(0,t.jsxs)("div",{children:[(0,t.jsx)("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:"Price Range"}),(0,t.jsxs)("select",{value:c,onChange:e=>h(e.target.value),className:"w-full px-3 py-2 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500",children:[(0,t.jsx)("option",{value:"all",children:"All Prices"}),(0,t.jsx)("option",{value:"0-199",children:"Under $200"}),(0,t.jsx)("option",{value:"200-299",children:"$200-$299"}),(0,t.jsx)("option",{value:"300-399",children:"$300-$399"}),(0,t.jsx)("option",{value:"400-Infinity",children:"$400+"})]})]}),(0,t.jsxs)("div",{children:[(0,t.jsx)("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:"Side Impact Protection"}),(0,t.jsxs)("select",{value:d,onChange:e=>g(e.target.value),className:"w-full px-3 py-2 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500",children:[(0,t.jsx)("option",{value:"all",children:"Any"}),(0,t.jsx)("option",{value:"yes",children:"Yes"})]})]}),(0,t.jsxs)("div",{children:[(0,t.jsx)("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:"Install Method"}),(0,t.jsxs)("select",{value:m,onChange:e=>f(e.target.value),className:"w-full px-3 py-2 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500",children:[(0,t.jsx)("option",{value:"all",children:"Any Method"}),(0,t.jsx)("option",{value:"LATCH",children:"LATCH"}),(0,t.jsx)("option",{value:"Seatbelt",children:"Seatbelt"})]})]}),(0,t.jsxs)("div",{children:[(0,t.jsx)("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:"Sort By"}),(0,t.jsxs)("select",{value:u,onChange:e=>p(e.target.value),className:"w-full px-3 py-2 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500",children:[(0,t.jsx)("option",{value:"name",children:"Name A-Z"}),(0,t.jsx)("option",{value:"price-low",children:"Price: Low to High"}),(0,t.jsx)("option",{value:"price-high",children:"Price: High to Low"}),(0,t.jsx)("option",{value:"rating",children:"Highest Rated"})]})]})]}),(0,t.jsxs)("p",{className:"text-sm text-gray-600 mt-4",children:["Showing ",b.length," of ",i.length," car seats"]})]})}),(0,t.jsxs)("section",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8",children:[(0,t.jsx)("h2",{className:"text-2xl font-bold text-gray-900 mb-6",children:"Full Comparison Table"}),(0,t.jsx)("div",{className:"overflow-x-auto",children:(0,t.jsxs)("table",{className:"w-full text-sm border-collapse",children:[(0,t.jsx)("thead",{className:"bg-gray-100",children:(0,t.jsxs)("tr",{children:[(0,t.jsx)("th",{className:"border border-gray-300 px-4 py-2 text-left font-bold",children:"Brand & Model"}),(0,t.jsx)("th",{className:"border border-gray-300 px-4 py-2 text-right font-bold",children:"Price"}),(0,t.jsx)("th",{className:"border border-gray-300 px-4 py-2 text-center font-bold",children:"Type"}),(0,t.jsx)("th",{className:"border border-gray-300 px-4 py-2 text-center font-bold",children:"Weight Range"}),(0,t.jsx)("th",{className:"border border-gray-300 px-4 py-2 text-right font-bold",children:"Rear-Facing Max"}),(0,t.jsx)("th",{className:"border border-gray-300 px-4 py-2 text-right font-bold",children:"Width (in)"}),(0,t.jsx)("th",{className:"border border-gray-300 px-4 py-2 text-center font-bold",children:"Side Impact"}),(0,t.jsx)("th",{className:"border border-gray-300 px-4 py-2 text-right font-bold",children:"Rating"}),(0,t.jsx)("th",{className:"border border-gray-300 px-4 py-2 text-center font-bold",children:"Amazon"})]})}),(0,t.jsx)("tbody",{children:b.map((e,a)=>{let s=(0,o.getAmazonLink)(e.amazonAsin);return(0,t.jsxs)("tr",{className:a%2==0?"bg-white":"bg-gray-50",children:[(0,t.jsxs)("td",{className:"border border-gray-300 px-4 py-2 font-semibold text-gray-900",children:[e.brand," ",e.model]}),(0,t.jsx)("td",{className:"border border-gray-300 px-4 py-2 text-right",children:(0,o.formatPrice)(e.price)}),(0,t.jsx)("td",{className:"border border-gray-300 px-4 py-2 text-center text-xs",children:(0,t.jsx)("span",{className:"bg-blue-100 text-blue-800 px-2 py-1 rounded",children:e.seatType.charAt(0).toUpperCase()+e.seatType.slice(1)})}),(0,t.jsxs)("td",{className:"border border-gray-300 px-4 py-2 text-center text-xs",children:[e.weightRangeMin,"-",e.weightRangeMax," lbs"]}),(0,t.jsxs)("td",{className:"border border-gray-300 px-4 py-2 text-right",children:[e.rearFacingMaxLbs," lbs"]}),(0,t.jsxs)("td",{className:"border border-gray-300 px-4 py-2 text-right text-xs",children:[e.seatWidthInches,'"']}),(0,t.jsx)("td",{className:"border border-gray-300 px-4 py-2 text-center",children:e.sideImpactProtection?(0,t.jsx)("span",{className:"text-green-600 font-semibold",children:"✓"}):(0,t.jsx)("span",{className:"text-gray-400",children:"-"})}),(0,t.jsxs)("td",{className:"border border-gray-300 px-4 py-2 text-right font-semibold",children:[e.rating,"⭐"]}),(0,t.jsx)("td",{className:"border border-gray-300 px-4 py-2 text-center",children:s?(0,t.jsx)("a",{href:s,target:"_blank",rel:"noopener noreferrer",className:"text-orange-600 hover:underline text-xs font-semibold",children:"View"}):(0,t.jsx)("span",{className:"text-gray-400 text-xs",children:"-"})})]},e.id)})})]})})]}),(0,t.jsxs)("section",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12",children:[(0,t.jsx)("h2",{className:"text-2xl font-bold text-gray-900 mb-8",children:"Detailed Product Summaries"}),(0,t.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-6",children:b.map(e=>(0,t.jsxs)("div",{className:"border border-gray-300 rounded-lg p-6 bg-white",children:[(0,t.jsx)("div",{className:"flex justify-between items-start mb-3",children:(0,t.jsxs)("div",{children:[(0,t.jsxs)("h3",{className:"text-lg font-bold text-gray-900",children:[e.brand," ",e.model]}),(0,t.jsx)("p",{className:"text-sm text-gray-600",children:e.summary})]})}),(0,t.jsxs)("div",{className:"border-t border-gray-200 pt-4 mt-4",children:[(0,t.jsxs)("div",{className:"grid grid-cols-2 gap-2 text-sm",children:[(0,t.jsxs)("div",{children:[(0,t.jsx)("p",{className:"font-semibold text-gray-700",children:"Price"}),(0,t.jsx)("p",{className:"text-gray-600",children:(0,o.formatPrice)(e.price)})]}),(0,t.jsxs)("div",{children:[(0,t.jsx)("p",{className:"font-semibold text-gray-700",children:"Type"}),(0,t.jsx)("p",{className:"text-gray-600",children:e.seatType.charAt(0).toUpperCase()+e.seatType.slice(1)})]}),(0,t.jsxs)("div",{children:[(0,t.jsx)("p",{className:"font-semibold text-gray-700",children:"Weight Range"}),(0,t.jsxs)("p",{className:"text-gray-600",children:[e.weightRangeMin,"-",e.weightRangeMax," lbs"]})]}),(0,t.jsxs)("div",{children:[(0,t.jsx)("p",{className:"font-semibold text-gray-700",children:"Width"}),(0,t.jsxs)("p",{className:"text-gray-600",children:[e.seatWidthInches,'"']})]}),(0,t.jsxs)("div",{children:[(0,t.jsx)("p",{className:"font-semibold text-gray-700",children:"Installation"}),(0,t.jsx)("p",{className:"text-gray-600",children:e.installMethod})]}),(0,t.jsxs)("div",{children:[(0,t.jsx)("p",{className:"font-semibold text-gray-700",children:"Rating"}),(0,t.jsxs)("p",{className:"text-gray-600",children:[e.rating,"⭐"]})]})]}),(0,t.jsxs)("div",{className:"mt-4 flex gap-2",children:[e.sideImpactProtection&&(0,t.jsx)("span",{className:"inline-block bg-green-100 text-green-800 text-xs px-2 py-1 rounded",children:"Side Impact Protection"}),e.antiRebound&&(0,t.jsx)("span",{className:"inline-block bg-green-100 text-green-800 text-xs px-2 py-1 rounded",children:"Anti-Rebound Bar"}),e.steelFrame&&(0,t.jsx)("span",{className:"inline-block bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded",children:"Steel Frame"}),e.washableCover&&(0,t.jsx)("span",{className:"inline-block bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded",children:"Washable Cover"})]}),(0,t.jsx)("div",{className:"mt-4 flex gap-2",children:(0,o.getAmazonLink)(e.amazonAsin)&&(0,t.jsx)("a",{href:(0,o.getAmazonLink)(e.amazonAsin)||"#",target:"_blank",rel:"noopener noreferrer",className:"flex-1 bg-orange-500 text-white px-3 py-2 rounded text-center text-sm font-semibold hover:bg-orange-600",children:"View on Amazon"})})]})]},e.id))})]})]})}e.s(["default",()=>l],2430)}]);