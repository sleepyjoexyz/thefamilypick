...
Start with your base stroller and identify actual friction points over the first month. Then invest in accessories that address those specific problems. Most parents find that 3-4 well-chosen accessories dramatically improve their strolling experience without cluttering their setup.`}};var o=e.i(75157),n=e.i(22016);function l(){let[e,l]=(0,r.useState)("all"),[d,c]=(0,r.useState)("0"),[h,u]=(0,r.useState)("1500"),[g,m]=(0,r.useState)("all"),[p,y]=(0,r.useState)("all"),[f,b]=(0,r.useState)("name"),w=(0,r.useMemo)(()=>{let t=[...a];"all"!==e&&(t=t.filter(t=>t.strollerType===e));let r=parseInt(d)||0,i=parseInt(h)||1500;if(t=t.filter(e=>e.price>=r&&e.price<=i),"all"!==g){let e="yes"===g;t=t.filter(t=>t.carSeatCompatible===e)}if("all"!==p){let e="yes"===p;t=t.filter(t=>t.oneBoardFold===e)}return"price-low"===f?t.sort((e,t)=>e.price-t.price):"price-high"===f?t.sort((e,t)=>t.price-e.price):"rating"===f?t.sort((e,t)=>t.rating-e.rating):"weight"===f?t.sort((e,t)=>e.weightLbs-t.weightLbs):t.sort((e,t)=>`${e.brand} ${e.model}`.localeCompare(`${t.brand} ${t.model}`)),t},[e,d,h,g,p,f]);return(0,t.jsxs)("div",{className:"bg-white",children:[(0,t.jsx)("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6",children:(0,t.jsx)(i.default,{items:[{label:"Strollers",href:"/strollers"}]})}),(0,t.jsxs)("section",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12",children:[(0,t.jsx)("h1",{className:"text-4xl font-bold text-gray-900 mb-4",children:"Best Strollers Compared — 2025-2026"}),(0,t.jsx)("p",{className:"text-lg text-gray-600 mb-6",children:"We've analyzed 14 strollers across all types: full-size, lightweight, jogging, double, and travel-system models. Compare prices, weights, recline positions, car seat compatibility, and features to find the stroller that matches your lifestyle. Our methodology is based on manufacturer specifications, real-world testing, and parent feedback."})]}),(0,t.jsxs)("section",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8",children:[(0,t.jsxs)("div",{className:"bg-white border border-gray-200 rounded-lg p-6 mb-8",children:[(0,t.jsx)("h2",{className:"font-bold text-lg text-gray-900 mb-6",children:"Filters & Sort"}),(0,t.jsxs)("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4",children:[(0,t.jsxs)("div",{children:[(0,t.jsx)("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:"Stroller Type"}),(0,t.jsxs)("select",{value:e,onChange:e=>l(e.target.value),className:"w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500",children:[(0,t.jsx)("option",{value:"all",children:"All Types"}),(0,t.jsx)("option",{value:"full-size",children:"Full-Size"}),(0,t.jsx)("option",{value:"lightweight",children:"Lightweight"}),(0,t.jsx)("option",{value:"jogging",children:"Jogging"}),(0,t.jsx)("option",{value:"double",children:"Double"}),(0,t.jsx)("option",{value:"travel-system",children:"Travel System"})]})]}),(0,t.jsxs)("div",{children:[(0,t.jsx)("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:"Min Price"}),(0,t.jsx)("input",{type:"number",value:d,onChange:e=>c(e.target.value),placeholder:"0",className:"w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"})]}),(0,t.jsxs)("div",{children:[(0,t.jsx)("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:"Max Price"}),(0,t.jsx)("input",{type:"number",value:h,onChange:e=>u(e.target.value),placeholder:"1500",className:"w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"})]}),(0,t.jsxs)("div",{children:[(0,t.jsx)("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:"Car Seat Compatible"}),(0,t.jsxs)("select",{value:g,onChange:e=>m(e.target.value),className:"w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500",children:[(0,t.jsx)("option",{value:"all",children:"All"}),(0,t.jsx)("option",{value:"yes",children:"Yes"}),(0,t.jsx)("option",{value:"no",children:"No"})]})]}),(0,t.jsxs)("div",{children:[(0,t.jsx)("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:"One-Hand Fold"}),(0,t.jsxs)("select",{value:p,onChange:e=>y(e.target.value),className:"w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500",children:[(0,t.jsx)("option",{value:"all",children:"All"}),(0,t.jsx)("option",{value:"yes",children:"Yes"}),(0,t.jsx)("option",{value:"no",children:"No"})]})]}),(0,t.jsxs)("div",{children:[(0,t.jsx)("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:"Sort By"}),(0,t.jsxs)("select",{value:f,onChange:e=>b(e.target.value),className:"w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500",children:[(0,t.jsx)("option",{value:"name",children:"Brand & Model"}),(0,t.jsx)("option",{value:"price-low",children:"Price (Low to High)"}),(0,t.jsx)("option",{value:"price-high",children:"Price (High to Low)"}),(0,t.jsx)("option",{value:"rating",children:"Rating (Highest)"}),(0,t.jsx)("option",{value:"weight",children:"Weight (Lightest)"})]})]})]})]}),(0,t.jsxs)("p",{className:"text-gray-600 mb-6",children:["Showing ",w.length," of ",a.length," strollers"]})]}),(0,t.jsx)("section",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8",children:(0,t.jsx)("div",{className:"overflow-x-auto border border-gray-200 rounded-lg",children:(0,t.jsxs)("table",{className:"w-full",children:[(0,t.jsx)("thead",{children:(0,t.jsxs)("tr",{className:"bg-gray-50 border-b border-gray-200",children:[(0,t.jsx)("th",{className:"px-6 py-3 text-left text-sm font-semibold text-gray-900",children:"Brand & Model"}),(0,t.jsx)("th",{className:"px-6 py-3 text-left text-sm font-semibold text-gray-900",children:"Price"}),(0,t.jsx)("th",{className:"px-6 py-3 text-left text-sm font-semibold text-gray-900",children:"Type"}),(0,t.jsx)("th",{className:"px-6 py-3 text-left text-sm font-semibold text-gray-900",children:"Weight (lbs)"}),(0,t.jsx)("th",{className:"px-6 py-3 text-left text-sm font-semibold text-gray-900",children:"Max Child Wt (lbs)"}),(0,t.jsx)("th",{className:"px-6 py-3 text-left text-sm font-semibold text-gray-900",children:"Recline"}),(0,t.jsx)("th",{className:"px-6 py-3 text-left text-sm font-semibold text-gray-900",children:"Car Seat"}),(0,t.jsx)("th",{className:"px-6 py-3 text-left text-sm font-semibold text-gray-900",children:"Rating"}),(0,t.jsx)("th",{className:"px-6 py-3 text-left text-sm font-semibold text-gray-900",children:"Amazon"})]})}),(0,t.jsx)("tbody",{className:"divide-y divide-gray-200",children:w.map(e=>(0,t.jsxs)("tr",{className:"hover:bg-gray-50",children:[(0,t.jsxs)("td",{className:"px-6 py-4 text-sm font-medium text-gray-900",children:[e.brand," ",e.model]}),(0,t.jsx)("td",{className:"px-6 py-4 text-sm text-gray-600",children:(0,o.formatPrice)(e.price)}),(0,t.jsx)("td",{className:"px-6 py-4 text-sm text-gray-600",children:(0,t.jsx)("span",{className:"inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800",children:e.strollerType})}),(0,t.jsx)("td",{className:"px-6 py-4 text-sm text-gray-600",children:e.weightLbs}),(0,t.jsx)("td",{className:"px-6 py-4 text-sm text-gray-600",children:e.maxChildWeightLbs}),(0,t.jsxs)("td",{className:"px-6 py-4 text-sm text-gray-600",children:[e.reclinePositions," positions"]}),(0,t.jsx)("td",{className:"px-6 py-4 text-sm text-gray-600",children:e.carSeatCompatible?(0,t.jsx)("span",{className:"text-green-600 font-medium",children:"Yes"}):(0,t.jsx)("span",{className:"text-gray-400",children:"No"})}),(0,t.jsx)("td",{className:"px-6 py-4 text-sm font-medium",children:(0,t.jsxs)("span",{className:"inline-flex items-center",children:[(0,t.jsx)("span",{className:"text-yellow-400",children:"★"}),(0,t.jsx)("span",{className:"ml-1 text-gray-900",children:(0,o.formatRating)(e.rating)})]})}),(0,t.jsx)("td",{className:"px-6 py-4 text-sm",children:(0,o.getAmazonLink)(e.amazonAsin)?(0,t.jsx)("a",{href:(0,o.getAmazonLink)(e.amazonAsin)||"#",target:"_blank",rel:"noopener noreferrer",className:"text-blue-600 hover:underline font-medium",children:"View"}):(0,t.jsx)("span",{className:"text-gray-400",children:"N/A"})})]},e.id))})]})})}),(0,t.jsxs)("section",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-t border-gray-200",children:[(0,t.jsx)("h2",{className:"text-2xl font-bold text-gray-900 mb-6",children:"Stroller Guides & Articles"}),(0,t.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-6",children:Object.values(s).map(e=>(0,t.jsxs)(n.default,{href:`/strollers/${e.slug}`,className:"border border-gray-200 rounded-lg p-6 hover:border-blue-500 hover:shadow-lg transition",children:[(0,t.jsx)("h3",{className:"font-bold text-lg text-gray-900 mb-2",children:e.title}),(0,t.jsx)("p",{className:"text-gray-600 text-sm",children:e.description})]},e.slug))})]}),(0,t.jsx)("section",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-t border-gray-200",children:(0,t.jsx)("p",{className:"text-gray-600 text-sm",children:"This stroller comparison was prepared with AI-assisted research. All specifications and pricing are based on current manufacturer data and Amazon product listings. Prices and availability may change. For the most current information, please visit the manufacturers' websites or product pages."})})]})}e.s(["default",()=>l],31701)}]);