...
Smart integration of portable ACs is possible but limited. A simple smart plug ($25) handles basic on/off control and scheduling. For true temperature-based automation, add a smart temperature sensor ($25) and set up routines. A WiFi-enabled portable AC offers better control but at a higher cost and with limited model selection. Unless you really want app control of temperature, a smart plug is sufficient for most needs. Don't expect portable AC + smart plug to work as seamlessly as a true smart thermostat system—that level of integration isn't really possible with a plug-and-play portable AC.`}};var d=a.i(84686),e=a.i(16472),f=a.i(95936);async function g(){return Object.keys(c).map(a=>({slug:a}))}async function h({params:a},b){let d=(await a).slug,e=c[d]||null;return e?{title:`${e.title} | The Family Pick`,description:e.description,openGraph:{title:e.title,description:e.description,type:"article",url:`https://thefamilypick.com/climate-control/${d}`}}:{title:"Article Not Found"}}async function i({params:a}){let g=(await a).slug,h=c[g]||null;return h?(0,b.jsxs)("div",{className:"bg-white",children:[(0,b.jsx)("div",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-6",children:(0,b.jsx)(d.default,{items:[{label:"Climate Control",href:"/climate-control"},{label:h.title,href:`/climate-control/${g}`}]})}),(0,b.jsxs)("article",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12",children:[(0,b.jsxs)("header",{className:"mb-8",children:[(0,b.jsx)("h1",{className:"text-4xl font-bold text-gray-900 mb-4",children:h.title}),(0,b.jsx)("p",{className:"text-xl text-gray-600",children:h.description})]}),(0,b.jsx)("div",{className:"prose prose-lg max-w-none text-gray-700 mb-8",dangerouslySetInnerHTML:{__html:h.content}})]}),(0,b.jsx)(e.default,{slug:g,category:"climate-control"}),(0,b.jsxs)("section",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-t border-gray-200",children:[(0,b.jsx)("h2",{className:"text-2xl font-bold text-gray-900 mb-6",children:"Related Articles"}),(0,b.jsx)(f.default,{href:"/climate-control",className:"text-blue-600 hover:underline",children:"← Back to Climate Control"})]})]}):(0,b.jsxs)("div",{className:"max-w-4xl mx-auto px-4 py-12",children:[(0,b.jsx)("h1",{className:"text-3xl font-bold text-gray-900",children:"Article Not Found"}),(0,b.jsx)("p",{className:"text-gray-600 mt-2",children:"The article you're looking for doesn't exist."}),(0,b.jsx)(f.default,{href:"/climate-control",className:"text-blue-600 hover:underline mt-4 inline-block",children:"Back to Climate Control"})]})}a.s(["default",()=>i,"generateMetadata",()=>h,"generateStaticParams",()=>g],91891)}];

//# sourceMappingURL=src_app_climate-control_%5Bslug%5D_page_tsx_01cc4172._.js.map