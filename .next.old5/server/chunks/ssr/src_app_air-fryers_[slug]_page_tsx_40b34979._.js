...
Invest accessory money only if you use your air fryer multiple times per week. For casual users, paper liners alone solve most problems. For serious cooks, a combination of liners, racks, and a grill pan unlocks versatility without breaking the budget.`}};var d=a.i(84686),e=a.i(16472),f=a.i(95936);async function g(){return Object.keys(c).map(a=>({slug:a}))}async function h({params:a},b){let d=(await a).slug,e=c[d]||null;return e?{title:`${e.title} | The Family Pick`,description:e.description,openGraph:{title:e.title,description:e.description,type:"article",url:`https://thefamilypick.com/air-fryers/${d}`}}:{title:"Article Not Found"}}async function i({params:a}){let g=(await a).slug,h=c[g]||null;return h?(0,b.jsxs)("div",{className:"bg-white",children:[(0,b.jsx)("div",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-6",children:(0,b.jsx)(d.default,{items:[{label:"Air Fryers",href:"/air-fryers"},{label:h.title,href:`/air-fryers/${g}`}]})}),(0,b.jsxs)("article",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12",children:[(0,b.jsxs)("header",{className:"mb-8",children:[(0,b.jsx)("h1",{className:"text-4xl font-bold text-gray-900 mb-4",children:h.title}),(0,b.jsx)("p",{className:"text-xl text-gray-600",children:h.description})]}),(0,b.jsx)("div",{className:"prose prose-lg max-w-none text-gray-700 mb-8",dangerouslySetInnerHTML:{__html:h.content}})]}),(0,b.jsx)(e.default,{pagePath:`/air-fryers/${g}`,siteName:"thefamilypick"}),(0,b.jsxs)("section",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-t border-gray-200",children:[(0,b.jsx)("h2",{className:"text-2xl font-bold text-gray-900 mb-6",children:"Related Articles"}),(0,b.jsx)(f.default,{href:"/air-fryers",className:"text-blue-600 hover:underline",children:"← Back to Air Fryers"})]})]}):(0,b.jsxs)("div",{className:"max-w-4xl mx-auto px-4 py-12",children:[(0,b.jsx)("h1",{className:"text-3xl font-bold text-gray-900",children:"Article Not Found"}),(0,b.jsx)("p",{className:"text-gray-600 mt-2",children:"The article you're looking for doesn't exist."}),(0,b.jsx)(f.default,{href:"/air-fryers",className:"text-blue-600 hover:underline mt-4 inline-block",children:"Back to Air Fryers"})]})}a.s(["default",()=>i,"generateMetadata",()=>h,"generateStaticParams",()=>g],33545)}];

//# sourceMappingURL=src_app_air-fryers_%5Bslug%5D_page_tsx_40b34979._.js.map