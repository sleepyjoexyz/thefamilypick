module.exports=[58302,a=>{"use strict";var b=a.i(7997);let c={"infant-vs-convertible-car-seat":{slug:"infant-vs-convertible-car-seat",title:"Infant vs Convertible Car Seats: Which Should You Buy First?",description:"Compare infant car seats and convertible car seats. Learn about safety, convenience, cost, and durability to decide which is right for your family.",category:"car-seats",content:`## Introduction
...
A seat with an excellent IIHS rating installed correctly will provide superior protection to an untested seat installed poorly. Buy the best-rated seat you can afford, install it correctly, and verify installation before every drive. That discipline matters more than selecting between nearly-equivalent certified seats.`}};var d=a.i(84686),e=a.i(16472),f=a.i(95936);async function g(){return Object.keys(c).map(a=>({slug:a}))}async function h({params:a},b){let d=(await a).slug,e=c[d];return e?{title:`${e.title} | The Family Pick`,description:e.description,openGraph:{title:e.title,description:e.description,type:"article",url:`https://thefamilypick.com/car-seats/${d}`}}:{title:"Article Not Found"}}async function i({params:a}){let g=(await a).slug,h=c[g];return h?(0,b.jsxs)("article",{className:"bg-white",children:[(0,b.jsx)("div",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-6",children:(0,b.jsx)(d.default,{items:[{label:"Car Seats",href:"/car-seats"},{label:h.title,href:`/car-seats/${g}`}]})}),(0,b.jsxs)("section",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-b border-gray-200",children:[(0,b.jsx)("h1",{className:"text-4xl font-bold text-gray-900 mb-4",children:h.title}),(0,b.jsx)("p",{className:"text-lg text-gray-600",children:h.description})]}),(0,b.jsx)("section",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12",children:(0,b.jsx)("div",{className:"prose prose-lg max-w-none text-gray-700",children:h.content.split("\n\n").map((a,c)=>{if(a.startsWith("##")){let d=a.replace("## ","");return(0,b.jsx)("h2",{className:"text-2xl font-bold text-gray-900 mt-8 mb-4",children:d},c)}if(a.startsWith("###")){let d=a.replace("### ","");return(0,b.jsx)("h3",{className:"text-xl font-bold text-gray-900 mt-6 mb-3",children:d},c)}if(a.startsWith("|")){let d=a.split("\n"),e=d[0].split("|").map(a=>a.trim()).filter(a=>a),f=d.slice(2).map(a=>a.split("|").map(a=>a.trim()).filter(a=>a));return(0,b.jsx)("div",{className:"overflow-x-auto my-6",children:(0,b.jsxs)("table",{className:"w-full border-collapse text-sm",children:[(0,b.jsx)("thead",{className:"bg-gray-100",children:(0,b.jsx)("tr",{children:e.map((a,c)=>(0,b.jsx)("th",{className:"border border-gray-300 px-4 py-2 text-left font-bold",children:a},c))})}),(0,b.jsx)("tbody",{children:f.map((a,c)=>(0,b.jsx)("tr",{className:c%2==0?"bg-white":"bg-gray-50",children:a.map((a,c)=>(0,b.jsx)("td",{className:"border border-gray-300 px-4 py-2",children:a},c))},c))})]})},c)}if(a.startsWith("-")){let d=a.split("\n").filter(a=>a.trim().startsWith("-")).map(a=>a.replace(/^-\s*/,""));return(0,b.jsx)("ul",{className:"list-disc list-inside my-4 space-y-1",children:d.map((a,c)=>(0,b.jsx)("li",{className:"text-gray-700",children:a},c))},c)}return a.trim()?(0,b.jsx)("p",{className:"text-gray-700 leading-relaxed my-4",children:a},c):null})})}),(0,b.jsx)(e.default,{pagePath:`/car-seats/${g}`,siteName:"thefamilypick"}),(0,b.jsx)("section",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 border-t border-gray-200",children:(0,b.jsx)(f.default,{href:"/car-seats",className:"inline-block bg-blue-600 text-white px-6 py-2 rounded font-semibold hover:bg-blue-700",children:"Back to Car Seats Comparison"})})]}):(0,b.jsxs)("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12",children:[(0,b.jsx)("h1",{className:"text-2xl font-bold text-gray-900",children:"Article not found"}),(0,b.jsx)("p",{className:"text-gray-600 mt-4",children:(0,b.jsx)(f.default,{href:"/car-seats",className:"text-blue-600 hover:underline",children:"Back to car seats"})})]})}a.s(["default",()=>i,"generateMetadata",()=>h,"generateStaticParams",()=>g],58302)}];

//# sourceMappingURL=src_app_car-seats_%5Bslug%5D_page_tsx_8b3c3c5a._.js.map