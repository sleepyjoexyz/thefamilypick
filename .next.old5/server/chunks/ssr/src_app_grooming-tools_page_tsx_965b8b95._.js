...
Long double-coat owners: Be realistic about commitment. These coats require either daily home brushing or professional grooming every 4-6 weeks. Anything less results in matting that requires shaving. Budget your time and money accordingly.`}};var g=a.i(38246),h=a.i(68114);function i(){let[a,i]=(0,c.useState)("all"),[j,k]=(0,c.useState)("all"),[l,m]=(0,c.useState)("all"),[n,o]=(0,c.useState)("all"),[p,q]=(0,c.useState)("name"),r=(0,c.useMemo)(()=>{let b=[...e];if("all"!==a&&(b=b.filter(b=>b.toolType===a)),"all"!==j&&(b=b.filter(a=>a.petType===j||"both"===a.petType)),"all"!==n){let a="yes"===n;b=b.filter(b=>b.cordless===a)}return"all"!==l&&("budget"===l?b=b.filter(a=>a.price<100):"mid"===l?b=b.filter(a=>a.price>=100&&a.price<300):"premium"===l&&(b=b.filter(a=>a.price>=300))),"price-low"===p?b.sort((a,b)=>a.price-b.price):"price-high"===p?b.sort((a,b)=>b.price-a.price):"rating"===p?b.sort((a,b)=>b.rating-a.rating):b.sort((a,b)=>`${a.brand} ${a.model}`.localeCompare(`${b.brand} ${b.model}`)),b},[a,j,l,n,p]);return(0,b.jsxs)("div",{className:"bg-white",children:[(0,b.jsx)("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6",children:(0,b.jsx)(d.default,{items:[{label:"Grooming Tools",href:"/grooming-tools"}]})}),(0,b.jsxs)("section",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12",children:[(0,b.jsx)("h1",{className:"text-4xl font-bold text-gray-900 mb-4",children:"Best Pet Grooming Tools Compared — 2025-2026"}),(0,b.jsx)("p",{className:"text-lg text-gray-600 mb-6",children:"We've analyzed 20+ grooming tools for dogs and cats—from traditional clippers and de-shedding tools to innovative vacuum groomers and cordless nail grinders. Compare performance, noise levels, battery life, pet comfort, and price across all grooming needs."}),(0,b.jsx)("p",{className:"text-base text-gray-600 mb-6",children:"Our methodology is based on manufacturer specifications, user ratings, durability testing, and real-world grooming performance data."})]}),Object.keys(f).length>0&&(0,b.jsxs)("section",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-t border-gray-200",children:[(0,b.jsx)("h2",{className:"text-2xl font-bold text-gray-900 mb-6",children:"Helpful Guides"}),(0,b.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-6",children:Object.values(f).map(a=>(0,b.jsxs)(g.default,{href:`/grooming-tools/${a.slug}`,className:"border border-gray-200 rounded-lg p-6 hover:border-blue-500 hover:shadow-lg transition",children:[(0,b.jsx)("h3",{className:"font-bold text-lg text-gray-900 mb-2",children:a.title}),(0,b.jsx)("p",{className:"text-gray-600 text-sm",children:a.description})]},a.slug))})]}),(0,b.jsx)("section",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-t border-gray-200",children:(0,b.jsxs)("div",{className:"bg-white border border-gray-200 rounded-lg p-6 mb-8",children:[(0,b.jsx)("h2",{className:"font-bold text-lg text-gray-900 mb-6",children:"Filters & Sort"}),(0,b.jsxs)("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4",children:[(0,b.jsxs)("div",{children:[(0,b.jsx)("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:"Tool Type"}),(0,b.jsxs)("select",{value:a,onChange:a=>i(a.target.value),className:"w-full px-3 py-2 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500",children:[(0,b.jsx)("option",{value:"all",children:"All Types"}),(0,b.jsx)("option",{value:"clipper",children:"Clippers"}),(0,b.jsx)("option",{value:"deshedding",children:"De-shedding"}),(0,b.jsx)("option",{value:"vacuum-groomer",children:"Vacuum Groomer"}),(0,b.jsx)("option",{value:"dryer",children:"Dryer"}),(0,b.jsx)("option",{value:"nail-grinder",children:"Nail Grinder"}),(0,b.jsx)("option",{value:"brush",children:"Brush"})]})]}),(0,b.jsxs)("div",{children:[(0,b.jsx)("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:"Pet Type"}),(0,b.jsxs)("select",{value:j,onChange:a=>k(a.target.value),className:"w-full px-3 py-2 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500",children:[(0,b.jsx)("option",{value:"all",children:"All Pets"}),(0,b.jsx)("option",{value:"dog",children:"Dogs"}),(0,b.jsx)("option",{value:"cat",children:"Cats"}),(0,b.jsx)("option",{value:"both",children:"Dogs & Cats"})]})]}),(0,b.jsxs)("div",{children:[(0,b.jsx)("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:"Cordless"}),(0,b.jsxs)("select",{value:n,onChange:a=>o(a.target.value),className:"w-full px-3 py-2 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500",children:[(0,b.jsx)("option",{value:"all",children:"All"}),(0,b.jsx)("option",{value:"yes",children:"Cordless"}),(0,b.jsx)("option",{value:"no",children:"Corded"})]})]}),(0,b.jsxs)("div",{children:[(0,b.jsx)("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:"Price Range"}),(0,b.jsxs)("select",{value:l,onChange:a=>m(a.target.value),className:"w-full px-3 py-2 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500",children:[(0,b.jsx)("option",{value:"all",children:"All Prices"}),(0,b.jsx)("option",{value:"budget",children:"Budget (< $100)"}),(0,b.jsx)("option",{value:"mid",children:"Mid-Range ($100-$300)"}),(0,b.jsx)("option",{value:"premium",children:"Premium (> $300)"})]})]}),(0,b.jsxs)("div",{children:[(0,b.jsx)("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:"Sort By"}),(0,b.jsxs)("select",{value:p,onChange:a=>q(a.target.value),className:"w-full px-3 py-2 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500",children:[(0,b.jsx)("option",{value:"name",children:"Brand & Model A-Z"}),(0,b.jsx)("option",{value:"price-low",children:"Price: Low to High"}),(0,b.jsx)("option",{value:"price-high",children:"Price: High to Low"}),(0,b.jsx)("option",{value:"rating",children:"Highest Rated"})]})]})]}),(0,b.jsxs)("p",{className:"text-sm text-gray-600 mt-4",children:["Showing ",r.length," of ",e.length," grooming tools"]})]})}),(0,b.jsxs)("section",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8",children:[(0,b.jsx)("h2",{className:"text-2xl font-bold text-gray-900 mb-6",children:"Full Comparison Table"}),(0,b.jsx)("div",{className:"overflow-x-auto border border-gray-200 rounded-lg",children:(0,b.jsxs)("table",{className:"w-full text-sm",children:[(0,b.jsx)("thead",{className:"bg-gray-50 border-b border-gray-200",children:(0,b.jsxs)("tr",{children:[(0,b.jsx)("th",{className:"px-4 py-3 text-left font-semibold text-gray-900",children:"Brand & Model"}),(0,b.jsx)("th",{className:"px-4 py-3 text-left font-semibold text-gray-900",children:"Type"}),(0,b.jsx)("th",{className:"px-4 py-3 text-left font-semibold text-gray-900",children:"Price"}),(0,b.jsx)("th",{className:"px-4 py-3 text-left font-semibold text-gray-900",children:"Rating"}),(0,b.jsx)("th",{className:"px-4 py-3 text-left font-semibold text-gray-900",children:"Cordless"}),(0,b.jsx)("th",{className:"px-4 py-3 text-left font-semibold text-gray-900",children:"Battery/Runtime"}),(0,b.jsx)("th",{className:"px-4 py-3 text-left font-semibold text-gray-900",children:"Features"}),(0,b.jsx)("th",{className:"px-4 py-3 text-left font-semibold text-gray-900",children:"Amazon Link"})]})}),(0,b.jsx)("tbody",{children:r.map(a=>{let c=(0,h.getAmazonLink)(a.amazonAsin),d=[a.waterproof&&"Waterproof",a.suctionPower&&"Suction"].filter(Boolean).join(", ");return(0,b.jsxs)("tr",{className:"border-b border-gray-200 hover:bg-gray-50",children:[(0,b.jsxs)("td",{className:"px-4 py-3 text-gray-900 font-medium",children:[a.brand," ",a.model]}),(0,b.jsx)("td",{className:"px-4 py-3 text-gray-600 capitalize",children:a.toolType.replace("-"," ")}),(0,b.jsx)("td",{className:"px-4 py-3 text-gray-900 font-semibold",children:(0,h.formatPrice)(a.price)}),(0,b.jsx)("td",{className:"px-4 py-3",children:(0,b.jsxs)("span",{className:"inline-flex items-center px-2.5 py-0.5 rounded-full text-sm font-medium bg-yellow-100 text-yellow-800",children:["★ ",(0,h.formatRating)(a.rating)]})}),(0,b.jsx)("td",{className:"px-4 py-3",children:(0,b.jsx)("span",{className:`inline-flex px-2 py-1 text-xs font-semibold rounded ${a.cordless?"bg-green-100 text-green-800":"bg-blue-100 text-blue-800"}`,children:a.cordless?"Cordless":"Corded"})}),(0,b.jsx)("td",{className:"px-4 py-3 text-gray-600",children:a.cordless?`${a.batteryMinutes}min`:"—"}),(0,b.jsx)("td",{className:"px-4 py-3 text-gray-600 text-xs",children:d||"Basic"}),(0,b.jsx)("td",{className:"px-4 py-3",children:c?(0,b.jsx)("a",{href:c,target:"_blank",rel:"noopener noreferrer",className:"text-blue-600 hover:underline font-medium",children:"View on Amazon →"}):(0,b.jsx)("span",{className:"text-gray-400",children:"N/A"})})]},a.id)})})]})})]}),(0,b.jsxs)("section",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-t border-gray-200",children:[(0,b.jsx)("h2",{className:"text-2xl font-bold text-gray-900 mb-8",children:"Detailed Product Reviews"}),(0,b.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6",children:r.map(a=>{let c=(0,h.getAmazonLink)(a.amazonAsin);return(0,b.jsxs)("div",{className:"border border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition",children:[(0,b.jsx)("div",{className:"bg-gray-100 h-48 flex items-center justify-center",children:(0,b.jsx)("img",{src:a.imageUrl,alt:`${a.brand} ${a.model}`,className:"w-full h-full object-cover",onError:a=>{a.target.src="https://images.unsplash.com/photo-1585314355797-a2c08b56e0e3?w=400"}})}),(0,b.jsxs)("div",{className:"p-4",children:[(0,b.jsxs)("h3",{className:"font-bold text-lg text-gray-900 mb-1",children:[a.brand," ",a.model]}),(0,b.jsxs)("div",{className:"flex items-center justify-between mb-3",children:[(0,b.jsx)("span",{className:"text-2xl font-bold text-gray-900",children:(0,h.formatPrice)(a.price)}),(0,b.jsxs)("span",{className:"inline-flex items-center px-2.5 py-0.5 rounded-full text-sm font-semibold bg-yellow-100 text-yellow-800",children:["★ ",(0,h.formatRating)(a.rating)]})]}),(0,b.jsx)("p",{className:"text-sm text-gray-600 mb-4 line-clamp-3",children:a.summary}),(0,b.jsxs)("div",{className:"space-y-2 mb-4 text-xs text-gray-700",children:[(0,b.jsxs)("div",{children:[(0,b.jsx)("strong",{children:"Type:"})," ",(0,b.jsx)("span",{className:"capitalize",children:a.toolType.replace("-"," ")})]}),(0,b.jsxs)("div",{children:[(0,b.jsx)("strong",{children:"Pet Size:"})," ",a.petSizeRange]}),(0,b.jsxs)("div",{children:[(0,b.jsx)("strong",{children:"Noise Level:"})," ",a.noiseLevel]}),(0,b.jsxs)("div",{children:[(0,b.jsx)("strong",{children:"Warranty:"})," ",a.warranty]})]}),(0,b.jsx)("div",{className:"grid grid-cols-2 gap-2 mb-4 text-xs",children:[{label:"Cordless",value:a.cordless},{label:"Waterproof",value:a.waterproof},{label:"Suction Power",value:a.suctionPower}].map(a=>(0,b.jsxs)("div",{className:"flex items-center",children:[(0,b.jsx)("span",{className:a.value?"text-green-600 font-bold mr-1":"text-gray-400 mr-1",children:a.value?"✓":"—"}),(0,b.jsx)("span",{className:"text-gray-600",children:a.label})]},a.label))}),c&&(0,b.jsx)("a",{href:c,target:"_blank",rel:"noopener noreferrer",className:"block w-full px-4 py-2 bg-blue-600 text-white text-center font-semibold rounded hover:bg-blue-700 transition",children:"View on Amazon"})]})]},a.id)})})]}),(0,b.jsx)("section",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-t border-gray-200",children:(0,b.jsx)("div",{className:"bg-blue-50 border border-blue-200 rounded-lg p-6",children:(0,b.jsxs)("p",{className:"text-sm text-gray-600",children:[(0,b.jsx)("strong",{children:"Disclaimer:"})," This comparison and analysis was prepared with AI-assisted research. All prices, specifications, and ratings are current as of 2025-2026 and based on manufacturer data and user reviews. Prices and availability may vary by retailer. Please verify product details on Amazon before purchasing. We earn affiliate commissions on qualifying purchases at no additional cost to you."]})})})]})}a.s(["default",()=>i],41873)}];

//# sourceMappingURL=src_app_grooming-tools_page_tsx_965b8b95._.js.map