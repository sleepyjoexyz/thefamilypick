...
The flat head is the workhorse—use it 80% of the time for general muscle massage. The small ball head is essential for trigger point release. Everything else (large ball, fork, cone, wedge, brush) is optional but useful for specific situations. Don't buy all attachment types unless you're a serious athlete or have chronic pain. Most people benefit from just two heads and save money by skipping the rest. When shopping for a massage gun, prioritize a quick-change system (magnetic or click-lock) so you can swap heads easily without fumbling with screws.`}};var d=a.i(84686),e=a.i(16472),f=a.i(95936);async function g(){return Object.keys(c).map(a=>({slug:a}))}async function h({params:a},b){let d=(await a).slug,e=c[d]||null;return e?{title:`${e.title} | The Family Pick`,description:e.description,openGraph:{title:e.title,description:e.description,type:"article",url:`https://thefamilypick.com/massage-guns/${d}`}}:{title:"Article Not Found"}}async function i({params:a}){let g=(await a).slug,h=c[g]||null;return h?(0,b.jsxs)("div",{className:"bg-white",children:[(0,b.jsx)("div",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-6",children:(0,b.jsx)(d.default,{items:[{label:"Massage Guns",href:"/massage-guns"},{label:h.title,href:`/massage-guns/${g}`}]})}),(0,b.jsxs)("article",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12",children:[(0,b.jsxs)("header",{className:"mb-8",children:[(0,b.jsx)("h1",{className:"text-4xl font-bold text-gray-900 mb-4",children:h.title}),(0,b.jsx)("p",{className:"text-xl text-gray-600",children:h.description})]}),(0,b.jsx)("div",{className:"prose prose-lg max-w-none text-gray-700 mb-8",dangerouslySetInnerHTML:{__html:h.content}})]}),(0,b.jsx)(e.default,{pagePath:`/massage-guns/${g}`,siteName:"thefamilypick"}),(0,b.jsxs)("section",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-t border-gray-200",children:[(0,b.jsx)("h2",{className:"text-2xl font-bold text-gray-900 mb-6",children:"Related Articles"}),(0,b.jsx)(f.default,{href:"/massage-guns",className:"text-blue-600 hover:underline",children:"← Back to Massage Guns"})]})]}):(0,b.jsxs)("div",{className:"max-w-4xl mx-auto px-4 py-12",children:[(0,b.jsx)("h1",{className:"text-3xl font-bold text-gray-900",children:"Article Not Found"}),(0,b.jsx)("p",{className:"text-gray-600 mt-2",children:"The article you're looking for doesn't exist."}),(0,b.jsx)(f.default,{href:"/massage-guns",className:"text-blue-600 hover:underline mt-4 inline-block",children:"Back to Massage Guns"})]})}a.s(["default",()=>i,"generateMetadata",()=>h,"generateStaticParams",()=>g],66045)}];

//# sourceMappingURL=src_app_massage-guns_%5Bslug%5D_page_tsx_30e6637b._.js.map