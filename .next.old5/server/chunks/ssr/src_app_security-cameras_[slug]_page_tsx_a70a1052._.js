...
Cloud storage offers convenience and remote access at the cost of privacy and ongoing subscription fees. After 5 years, a 3-camera cloud system costs $2,250; the same system in local storage costs under $1,000. Local storage keeps your footage private and owned, but requires home network setup and no remote access unless VPN is configured. For most homeowners, a hybrid approach wins: local storage by default with optional cloud backup for important events. This gives you privacy, affordability, and a safety net without the privacy trade-offs of always-cloud storage.`}};var d=a.i(84686),e=a.i(16472),f=a.i(95936);async function g(){return Object.keys(c).map(a=>({slug:a}))}async function h({params:a},b){let d=(await a).slug,e=c[d];return e?{title:`${e.title} | The Family Pick`,description:e.description,openGraph:{title:e.title,description:e.description,type:"article",url:`https://thefamilypick.com/security-cameras/${d}`}}:{title:"Article Not Found"}}async function i({params:a}){let g=(await a).slug,h=c[g];return h?(0,b.jsxs)("div",{className:"bg-white",children:[(0,b.jsx)("div",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-6",children:(0,b.jsx)(d.default,{items:[{label:"Security Cameras",href:"/security-cameras"},{label:h.title,href:`/security-cameras/${g}`}]})}),(0,b.jsxs)("article",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12",children:[(0,b.jsxs)("header",{className:"mb-8",children:[(0,b.jsx)("h1",{className:"text-4xl font-bold text-gray-900 mb-4",children:h.title}),(0,b.jsx)("p",{className:"text-xl text-gray-600",children:h.description})]}),(0,b.jsx)("div",{className:"prose prose-lg max-w-none text-gray-700 mb-8",dangerouslySetInnerHTML:{__html:h.content}})]}),(0,b.jsx)(e.default,{pagePath:`/security-cameras/${g}`,siteName:"thefamilypick"}),(0,b.jsxs)("section",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-t border-gray-200",children:[(0,b.jsx)("h2",{className:"text-2xl font-bold text-gray-900 mb-6",children:"Related Articles"}),(0,b.jsx)(f.default,{href:"/security-cameras",className:"text-blue-600 hover:underline",children:"← Back to Security Cameras"})]})]}):(0,b.jsxs)("div",{className:"max-w-4xl mx-auto px-4 py-12",children:[(0,b.jsx)("h1",{className:"text-3xl font-bold text-gray-900",children:"Article Not Found"}),(0,b.jsx)("p",{className:"text-gray-600 mt-2",children:"The article you're looking for doesn't exist."}),(0,b.jsx)(f.default,{href:"/security-cameras",className:"text-blue-600 hover:underline mt-4 inline-block",children:"Back to Security Cameras"})]})}a.s(["default",()=>i,"generateMetadata",()=>h,"generateStaticParams",()=>g],16124)}];

//# sourceMappingURL=src_app_security-cameras_%5Bslug%5D_page_tsx_a70a1052._.js.map