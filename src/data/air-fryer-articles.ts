export interface AirFryerArticle {
  slug: string;
  title: string;
  description: string;
  content: string;
...
export const airFryerArticles: Record<string, AirFryerArticle> = {
  "basket-vs-oven-air-fryer": {
    slug: "basket-vs-oven-air-fryer",
    title: "Basket vs Oven-Style Air Fryers: Which Design Is Better?",
    description:
...
Basket-style air fryers excel at their single task: fast, crispy frying. Oven-style units trade some crisping speed for versatility and capacity. Choose based on your kitchen space, cooking needs, and whether you want a dedicated fryer or an oven replacement.`,
  },

  "best-air-fryers-under-100": {
    slug: "best-air-fryers-under-100",
    title: "Best Air Fryers Under $100 in 2026",
    description:
      "Compare the best air fryers under $100. See what you gain and sacrifice at this price point.",
    category: "air-fryers",
    content: `## Introduction
...
export function getAirFryerArticle(slug: string): AirFryerArticle | null {
  return airFryerArticles[slug] || null;
}

export function getAllAirFryerArticleSlugs(): string[] {
  return Object.keys(airFryerArticles);
}
