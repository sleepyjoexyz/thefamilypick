export interface CarSeatArticle {
  slug: string;
  title: string;
  description: string;
  content: string;
...
export const carSeatArticles: Record<string, CarSeatArticle> = {
  "infant-vs-convertible-car-seat": {
    slug: "infant-vs-convertible-car-seat",
    title: "Infant vs Convertible Car Seats: Which Should You Buy First?",
    description:
      "Compare infant car seats and convertible car seats. Learn about safety, convenience, cost, and durability to decide which is right for your family.",
    category: "car-seats",
...
Neither choice is "wrong"—both paths are safe when properly installed. Your decision should reflect your family's lifestyle, budget, and priorities around convenience vs long-term investment.`,
  },
...
Master these five steps and you'll avoid 90% of common installation mistakes. If uncertain, visit a certified NHTSA technician for a quick verification check.`,
  },
...
export function getCarSeatArticle(slug: string): CarSeatArticle | undefined {
  return carSeatArticles[slug];
}

export function getAllCarSeatArticleSlugs(): string[] {
  return Object.keys(carSeatArticles);
}
