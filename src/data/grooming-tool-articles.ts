export interface GroomingToolArticle {
  slug: string;
  title: string;
  description: string;
  content: string;
...
For most households with active shedding breeds, a vacuum groomer saves time and stress that justifies the premium price. For casual groomers with small or low-shedding pets, traditional clippers remain the practical, cost-effective choice.`,
  },
...
**Clipper approach:**
- Initial clipper: $15
- Blade replacement/sharpening: $5/year × 5 = $25
- Total: $40
...
export function getGroomingToolArticle(slug: string): GroomingToolArticle | undefined {
  return groomingToolArticles[slug];
}

export function getAllGroomingToolArticleSlugs(): string[] {
  return Object.keys(groomingToolArticles);
}
