...
export default function RobotVacuumsComparison() {
  ...
  const productListItems = robotVacuums.map((p) => ({
  ...
  return (
    ...
    <div className="bg-white">
      ...
      <ProductListSchema
        ...
        categoryUrl="https://thefamilypick.com/robot-vacuums"
    ...
    <div className="bg-white">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <p className="text-lg text-gray-600 mb-6">
          We've analyzed and compared the top Robot Vacuums available today. Find the perfect
      ...
      {Object.keys(robotVacuumArticles).length > 0 && (
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-t border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {Object.values(robotVacuumArticles).map((article) => (
              <Link
                key={article.slug}
                href={`/robot-vacuums/${article.slug}`}
