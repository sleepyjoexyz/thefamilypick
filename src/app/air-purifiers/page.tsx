...
export const metadata: Metadata = {
  ...
  description: "Compare air purifiers by filtration, coverage area, noise level, and price. Breathe easier at home.",
  alternates: { canonical: "https://thefamilypick.com/air-purifiers" },
};
...
export default function AirPurifiersComparison() {
  ...
  const productListItems = airPurifiers.map((p) => ({
  ...
  return (
    ...
    <div className="bg-white">
      ...
      <ProductListSchema
        ...
        categoryUrl="https://thefamilypick.com/air-purifiers"
    ...
    <div className="bg-white">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <p className="text-lg text-gray-600 mb-6">
          We've analyzed and compared the top Air Purifiers available today. Find the perfect
      ...
      {Object.keys(airPurifierArticles).length > 0 && (
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-t border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {Object.values(airPurifierArticles).map((article) => (
              <Link
                key={article.slug}
                href={`/air-purifiers/${article.slug}`}
