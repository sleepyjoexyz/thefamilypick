...
export default async function ArticlePage({ params }: PageProps) {
  ...
  if (!article) {
    return (
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <Link href="/climate-control" className="text-blue-600 hover:underline mt-4 inline-block">
  ...
  return (
    <div className="bg-white">
      ...
      {/* Comments Section */}
      <Comments pagePath={`/climate-control/${slug}`} siteName="thefamilypick" />
